...
・assessment：名詞「評価、査定、評価額・課税額」。一般的な判断と、税・料金などの正式な査定の両方を表す。  
...
対象を調べ、基準に照らして、性質・程度・価値・負担額を決めることが中心にある。判断材料は情報・観察・経験などで、必ず明示的な基準や慎重な分析を伴うわけではない。対象の性質や適格性なら一般的な評価、量・金額・価値なら査定、税・料金などの負担なら賦課へ具体化する。  
・対象を調べ、情報・観察・経験などをもとに性質・適格性を判断すること → 「評価する、判断する」（語義1）  
・対象を調べ、金額・数量・価値を見積もり、査定結果を決めること → 「金額・数量・価値を査定する」（語義2）  
・制度に基づき税・料金・罰金などの金額を算定し、必要に応じて負担を課すこと → 「税・料金などを課す、賦課する」（語義3）  

＃意味・用法・関連表現

1. 【動詞・他動詞】評価する、判断する

【日本語訳・定義】情報・観察・経験などをもとに、人・物・能力・適格性・リスク・状況などの性質、質、重要性、必要性を判断・見積もる。明示的な基準や慎重な分析を伴うことが多いが、assess 自体が必ず客観的・正確・体系的な手続きだという意味までは含まない。  

【頻度】〈8/10〉  

【レジスター/領域】標準語。教育・採用・ビジネス・医療・行政・研究・安全管理など、基準や情報に基づく評価で広く使う。日常会話にも使えるが、think・judge より硬く、組織的・分析的な響きが出やすい。  

【文法パターン】assess 〈人・物・能力・リスク・状況〉＝〜を評価する／assess whether・what・how 〈節〉＝〜か・何を・どの程度か判断する／assess 〈O〉 as 〈形容詞〉＝〜を…だと評価する／assess someone for 〈病気・障害・適格性〉＝人に〜があるか・資格があるかを評価する／be assessed by 〈人・機関〉＝〜によって評価される。  
...
例: The committee assessed the proposal as impractical.  
訳: 委員会はその提案を実行不可能だと評価した。  
...
【日本語訳・定義】調査・比較・基準などに基づき、費用・価値・数量・金額などを見積もって査定結果を決める。厳密な計算結果に限らず、入手した情報からの判断・見積もりも含む。extent・severity・impact などは、数値化せず範囲・深刻さ・影響を評価する語義1寄りにもなる。assess the damage は被害の程度を見極める語義1寄りにも、被害額を査定するこの語義にもなり得るが、at 〈金額〉を伴うと金額査定が明確になる。  

【頻度】〈7/10〉  

【レジスター/領域】標準語。費用・価値・金額・数量の査定で多く、損害・影響・規模の評価にも語義1と重なって使う。分析・報告・保険・不動産・行政でよく見られる。金銭価値を専門家が査定する場合は appraise、数値を計算で出す場合は calculate、概算を述べる場合は estimate が選ばれやすい。  

【文法パターン】assess 〈O〉＝〜の量・価値を査定する／assess 〈O〉 at 〈金額・数値〉＝〜を…と査定する／assess the cost・value・amount of 〈O〉＝〜の費用・価値・量を査定する／be assessed at 〈金額・数値〉＝…と査定される。extent・severity・impact of 〈O〉は、語義1寄りの評価にも用いる。  

【コロケーション】

・assess the extent of 〈damage・problem〉  
用途: 被害や問題がどの範囲に及ぶかを評価する。数値や規模を見積もる場合は語義2寄りになる。  
例: The survey assessed the extent of the damage caused by the storm.  
訳: その調査は嵐による被害がどの範囲に及んだかを査定した。  

・assess the severity of 〈injury・condition〉  
用途: けがや状態の深刻さを評価する。数値化せず判断する場合は語義1寄りになる。  
例: The doctor assessed the severity of the injury before recommending treatment.  
訳: 医師は治療を勧める前に、けがの深刻さを査定した。  

・assess the impact of 〈change・project〉  
用途: 変化や計画が及ぼす影響を評価する。数値や規模を見積もる場合は語義2寄りになる。  
例: The study assessed the impact of the new law on small businesses.  
訳: その研究は新しい法律が小規模企業に与える影響を査定した。  
...
用途: 財産・損害・費用などが特定の金額や数値と査定される。  
例: The property was assessed at $300,000.  
訳: その不動産は30万ドルと査定された。  

【語法・注意】at 〈金額・数値〉は、査定によって得られた金額・数値を示す。assess 〈O〉 at 〈金額〉は、assess 〈O〉 as 〈形容詞〉のような性質の分類ではなく、価値・規模・金額の決定である。assess the cost は費用を見積もることであり、実際に請求したり支払ったりすることを必ずしも意味しない。assess the extent・severity・impact は、数値化せず評価する場合もあり、語義1との境界は文脈で決まる。assess the damage は被害の程度の評価にも被害額の査定にもなり得るため、金額なら at 〈金額〉などで明確にする。  
...
3. 【動詞・他動詞・正式／税務・法律】税・料金・罰金などの金額を算定し、課す

【日本語訳・定義】税・料金・罰金・特別負担などについて、制度や決められた率に基づき、誰にいくら負担させるかを正式に決める。文脈によっては金額・率の査定に焦点があり、assess a tax on 〈所得・財産〉のように負担を課すことまで含む場合もある。金額の査定（語義2）と負担を課すことが重なるが、assess は必ずしも実際の徴収・支払いまで意味しない。  

【頻度】〈5/10〉  

【レジスター/領域】正式・税務・法律。税、会費、料金、罰金の規則や通知で使われ、スポーツの規則文で反則・ペナルティを科す意味でも見られる。日常の「料金を請求する」には charge、「税や罰を公式に課す」には impose・levy が自然なことが多い。  

【文法パターン】assess a tax・fee・fine on 〈人・財産〉＝税・料金・罰金の金額を査定し、必要に応じて負担させる／assess 〈人・団体〉 a tax・fee＝人・団体に税・料金を課す／be assessed a tax・fee・fine＝税・料金・罰金を課される／assess 〈人・団体〉 for 〈tax・unpaid tax〉＝人・団体について税額・未納税額を査定する。  
