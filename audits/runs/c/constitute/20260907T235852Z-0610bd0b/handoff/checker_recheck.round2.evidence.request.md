...
Save exactly one JSON response as `../recheck_round2/evidence.response.json`. The top-level JSON must include the routed `pass_id` and a `reviewer` object with `mode: "handoff"`, the actual `declared_model`, `ingested_by: "human"`, and a non-empty unique `agent_id`.
...
```json
{
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "3713f209f4fdcf3684bdbfb7bdc09ba6df1b2f616f0c3f52dd2f6e12aaa6d8c1",
    "source_first_artifact_sha256": "f63969a81cebb477471a1f01a3a087b0a9c85d94795a22dc1626229395687f76",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
  ...
  "normalized_input_sha256": "258c26a0d52cde1acd07d4e141955ea55c7d337d7c5113004a29be00e821470f"
}
```
