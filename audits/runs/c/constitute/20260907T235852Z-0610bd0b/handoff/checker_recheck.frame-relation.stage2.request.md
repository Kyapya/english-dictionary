...
This stage must be executed by the same frame-relation subagent from stage 1: reviewer.agent_id=`constitute-recheck-frame-relation-1`, declared_model=`gpt-5`.

Save one `antonym_axis_adjudication_record_v1` JSON object as `checker_recheck.frame-relation.stage2.response.json`. Include the same top-level handoff `reviewer` metadata used by the frame-relation stage-1 response.
...
```json
{
  ...
  "blind_request_sha256": "716d8af0f69e502a4a68b5af4db97e5d9a76c5c01b494a7b3783880d4e05f4f3",
  "blind_record_sha256": "b41e24a01505e591197d5f0f1ae913f5b4a59fb32f400cbb8659643ba302e0c7",
  "input_sections": {
    "sense_structure": [
      {
        "line": 40,
