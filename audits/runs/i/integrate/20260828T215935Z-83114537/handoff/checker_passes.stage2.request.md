...
```json
{
  ...
  "blind_request_sha256": "8f47a4b635efe3c5389412c365de118cb97d8c714297572cf641bc4f510d5870",
  "blind_record_sha256": "323a3206674da851f82b74d7a1831f058207271077afa484739cb390b817ed26",
  "input_sections": {
    "sense_structure": [
      {
        "line": 49,
    ...
    "antonym_axis_items": [
      {
        ...
        "anchor": {
          ...
          "line_start": 139,
          "line_end": 139,
          "exact_quote": "・separate  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 142,
          "line_end": 142,
          "exact_quote": "違い: 一つにするか別々にするかという操作の向きが正反対で、程度の差ではない。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 146,
          "line_end": 146,
          "exact_quote": "・fragment  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 149,
          "line_end": 149,
          "exact_quote": "違い: 一つの全体にするのと逆に、細かく分かれて全体性が失われる方向を表す。市場、業界、社会について使うことが多い。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 153,
          "line_end": 153,
          "exact_quote": "・disintegrate  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 156,
          "line_end": 156,
          "exact_quote": "違い: 一体化とは逆の方向を表すが、意図的な分割ではなく、まとまりが失われて崩れるという結果に重点がある。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 243,
          "line_end": 243,
          "exact_quote": "・fragmented  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 246,
          "line_end": 246,
          "exact_quote": "違い: 一つのまとまりとして働くのとは逆に、分かれて全体性を欠く状態を表す。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 250,
          "line_end": 250,
          "exact_quote": "・disjointed  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 253,
          "line_end": 253,
          "exact_quote": "違い: つながりの欠如を否定的に述べる語で、話、文章、動きに使う。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 257,
          "line_end": 257,
          "exact_quote": "・standalone  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 260,
          "line_end": 260,
          "exact_quote": "違い: 他と結び付いていない点で反対だが、欠陥ではなく単独で完結しているという中立的な評価を伴う。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 423,
          "line_end": 423,
          "exact_quote": "・segregate  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 426,
          "line_end": 426,
          "exact_quote": "違い: 対等な構成員として受け入れるのとは逆に、意図的に分けて隔てる方向を表す。  "
        }
      },
      {
        ...
        "difference_anchor": {
          ...
          "line_start": 433,
          "line_end": 433,
          "exact_quote": "違い: 受け入れの反対方向で、参加そのものを認めないことを表す。別に分けて置く segregate と違い、外に置く点に重点がある。  "
        }
      },
      {
        ...
        "difference_anchor": {
          ...
          "line_start": 440,
          "line_end": 440,
          "exact_quote": "違い: 集団の一員にするのと逆に、関係を断って一人にする方向を表す。制度上の分離ではなく関係の断絶に重点がある。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 522,
          "line_end": 522,
          "exact_quote": "・withdraw  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 525,
          "line_end": 525,
          "exact_quote": "違い: 一員になっていく方向とは逆に、関係から離れていく方向を表す。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 529,
          "line_end": 529,
          "exact_quote": "・keep to oneself  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 532,
          "line_end": 532,
          "exact_quote": "違い: 集団に加わっていくのとは逆に、自分から関わりを持たない状態を表す。  "
        }
      },
      {
        ...
        "difference_anchor": {
          ...
          "line_start": 603,
          "line_end": 603,
          "exact_quote": "違い: 人種統合とは正反対の方向で、同じ意味軸の上で分ける側を表す。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 607,
          "line_end": 607,
          "exact_quote": "・resegregate  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 610,
          "line_end": 610,
          "exact_quote": "違い: 統合の後に元の分離状態へ戻る方向を表し、社会学や教育政策の議論で使う専門的な語である。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 673,
          "line_end": 673,
          "exact_quote": "・segregated  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 676,
          "line_end": 676,
          "exact_quote": "違い: 人種統合された状態とは正反対で、同じ意味軸の上で分けられた側を表す。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 680,
          "line_end": 680,
          "exact_quote": "・all-white  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 683,
          "line_end": 683,
          "exact_quote": "違い: 統合された状態とは逆に、単一の人種だけで構成されていることを述べる。分離が制度によるものかどうかは述べない。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 744,
          "line_end": 744,
          "exact_quote": "・differentiate  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 747,
          "line_end": 747,
          "exact_quote": "違い: 積分と微分は互いに逆の操作であり、同じ意味軸の上で正反対の方向を表す。  "
        }
      }
    ],
    "antonym_axis_senses": [
