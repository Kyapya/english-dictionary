...
同語源・関連語には divide「分ける」、division「分割・区分」、device「仕掛け・機器」がある。ただし device は devise の派生形ではなく、現代英語では品詞と語末子音が異なる別語として覚える。  

＃語形成

・devise → deviser：考案する人、または法律上の財産の譲渡者。一般用法では比較的まれで、法律用法では formal。  
...
・財産の行き先を定める遺言の条項 → 「遺贈条項、財産を譲る遺言上の処分」（語義4）  
...
【日本語訳・定義】問題解決、目的達成、状況への対応などのために、知識や材料を組み合わせて、新しい計画・方法・仕組み・装置などを頭の中で考え、具体的な形にする。単に思いつくことだけでなく、実用に向けて組み立てる過程を含みやすいが、考案したものが完成・成功することまで必ず意味するわけではない。  
...
【文法パターン】a devise of 〈property〉 to 〈beneficiary〉＝〈財産〉を〈受遺者〉へ譲る遺贈・処分／make a devise of 〈property〉＝〈財産〉の遺贈・処分を行う／a specific・general・residuary devise＝特定・一般・残余の遺贈／the validity・effect of a devise＝遺贈・処分の有効性・効果  
...
用途: 特定の一物ではなく、遺産全体の資産または残余財産から与える遺贈を区別する。  
...
4. 【名詞・可算・法律】遺贈条項、財産を譲る遺言上の処分

【日本語訳・定義】遺言書の中で、特定の財産を特定の受遺者へ譲る条項またはその文書上の処分を指す。法律文書では devise が処分行為、条項、処分対象財産のいずれを指すかが文脈で決まるため、a devise は常に遺言書全体を意味するわけではない。  

【頻度】〈1/10〉  

【レジスター/領域】法律・遺言書の非常に formal な用法。日常英語では clause in a will、will provision などに言い換える。  

【文法パターン】a devise in 〈a will〉＝遺言中の遺贈条項／a devise clause＝遺贈条項／the terms of a devise＝その遺贈条項・処分の文言／the will contains・includes a devise to 〈beneficiary〉＝遺言が〈受遺者〉への遺贈条項を含む  
...
・a devise clause  
用途: 財産を誰に譲るかを定める条項を、法律文書の構成要素として指す。  
例: The lawyer revised the devise clause to remove the ambiguity.  
訳: 弁護士は曖昧さをなくすため、遺贈条項を修正した。  
...
【語法・注意】devise が clause・provision の意味で使われるときも、通常は a devise in the will のように、どの遺言中の処分かを示す。the will 全体、すなわち遺言書そのものを指す一般語ではない。条項の意味か、そこで定められた財産か、処分行為かは、contains・interpret・challenge・receive など周囲の動詞と、specific・residuary などの修飾語から判断する。  
...
【文法パターン】receive・take a devise＝遺言による財産を受け取る／a specific・general・residuary devise＝特定・一般・残余の遺贈財産／the devise passes to 〈受遺者〉＝その遺贈財産が〈受遺者〉へ移る／property subject to a devise＝遺言による処分の対象となる財産  

【コロケーション】

・receive/take a devise  
用途: 受遺者が遺言によって与えられた財産を受け取ることを表す。  
...
【語法・注意】この語義では、devise は受遺者が受け取る財産または財産上の利益を指し、処分を定める条項そのものではない。receive、take、pass、property などの語が近くにあれば対象財産の意味になりやすい。伝統的には real property を指すが、現代法上の定義が広い場合もある。相続人が法律の規定によって受け取る財産全般を意味する inheritance より、遺言に記された特定の処分との結び付きが強い。  
