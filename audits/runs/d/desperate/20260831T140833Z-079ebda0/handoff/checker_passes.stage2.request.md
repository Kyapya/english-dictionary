    ...
    "antonym_axis_items": [
      {
        ...
        "difference_anchor": {
          ...
          "line_start": 110,
          "line_end": 110,
          "exact_quote": "違い: hopeful は希望が残っている状態、desperate は希望がほとんどなく追い詰められた状態を表す。両者は心理状態の軸で対立する。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 338,
          "line_end": 338,
          "exact_quote": "・promising  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 341,
          "line_end": 341,
          "exact_quote": "違い: promising は状況の明るい見込みを示し、desperate は状況が非常に悪く改善の望みが薄いことを示す。状況評価の軸で対立する。  "
        }
      }
    ],
    "antonym_axis_senses": [
