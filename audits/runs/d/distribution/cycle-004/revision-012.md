...
distribution list は、distribution の配布行為そのものではなく、メールなどの送信先一覧を指す定着複合名詞として別に覚える。  
