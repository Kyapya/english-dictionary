...
```json
{
    ...
    "antonym_items": [
      {
        ...
        "headword": "variation",
        "sense_definition": "【日本語訳・定義】量・水準・品質・状態などが一定ではなく変わること、またはその変化の幅・個々の違いを表す。変動・ばらつきを総体として述べる場合は不可算が多く、個々の変化・差・型を数える場合は可算になることが多い。変化が望ましいか望ましくないかは、文脈によって決まり、variation 自体には必ずしも悪い評価はない。",
        "antonym": "uniformity",
      ...
      },
      {
        ...
        "headword": "variation",
        "sense_definition": "【日本語訳・定義】同じ種・集団に属する個体の間に見られる、遺伝的・構造的・機能的な差を表す。基準や平均からの逸脱を必須とせず、個体間に自然に存在する差を中立的に指す。言語・地域・社会層などの一般的な形式差は語義1で扱う。",
        "antonym": "homogeneity",
  ...
  "normalized_input_sha256": "c63cc63b5cb7486c06585281ae21de09ffda4d6bc50a87c46ca37dde75b3a91c"
}
```
