...
Save exactly one JSON response as `recheck/evidence.response.json`. The top-level JSON must include the routed `pass_id` and a `reviewer` object with `mode: "handoff"`, the actual `declared_model`, `ingested_by: "human"`, and a non-empty `agent_id`. Each rechecked pass must use a different agent_id.
## Prompt
...
```json
{
  ...
  "input_sections": {
    ...
    "frames": [
      ...
      {
        "line": 161,
        "text": "【文法パターン】舞台芸術の役職は `a principal dancer`。オーケストラの役職は `the principal + be + the first player of 〈セクション〉`。  "
      },
      {
        "line": 186,
        "text": "4. 【名詞・金融／信託法】元金、元本、信託財産の元本"
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "da48e16fc1da7edd473a5ff38ab249ebf2fa036c0cdc2fefa2a6da9ab7b6fdea",
    "source_first_artifact_sha256": "e97de23f48433c92c1418c79368c269f37025be735dd52c0dced6832eb2c7705",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
        ...
        "source_supports": [
          {
            ...
            "support_summary": "Merriam-Webster directly supports the leading-performer role retained in the sense definition."
          },
          {
            "source_fact_id": "F-018",
            "support_summary": "Collins directly records principal dancer and the first player of an orchestral section, which bind the two displayed role frames."
          }
        ]
      },
      {
  ...
  "normalized_input_sha256": "d216e25db5d21c47887b98b288376c0988275705b80db3974cde653aa35feb23"
}
```
