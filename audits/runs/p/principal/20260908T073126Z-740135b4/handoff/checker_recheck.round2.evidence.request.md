...
Run this request in its own independent agent/session. The five invalidated checker passes may run concurrently; do not concatenate them or reuse one agent for multiple passes. Sense-structure and pronunciation are deterministically reused and must not be reviewed again.

Save exactly one JSON response as `recheck/round2/evidence.response.json`. The top-level JSON must include the routed `pass_id` and a `reviewer` object with `mode: "handoff"`, the actual `declared_model`, `ingested_by: "human"`, and a non-empty `agent_id`. Each round-2 reviewer agent_id must be unique and must differ from the reused reviewer IDs `/root/principal_cycle3_sense` and `principal-cycle3-pronunciation`.
## Prompt
...
```json
{
  ...
  "input_sections": {
    ...
    "frequency_register": [
      ...
      {
        "line": 131,
        "text": "【レジスター/領域】標準～やや形式的。企業・専門組織では権限または主導的地位を持つ人を表す。教育分野では学校・教育機関の長を表し、イングランドではカレッジの長を指す場合がある。  "
      },
      {
        "line": 158,
        "text": "3. 【名詞・可算】舞台芸術の主要演者、オーケストラの首席奏者"
    ...
    "frames": [
      ...
      {
        "line": 133,
        "text": "【文法パターン】一般の権限者は `a principal with controlling authority`。教育機関の長は `the principal + be + in charge of 〈学校〉`。  "
      },
      {
        "line": 158,
        "text": "3. 【名詞・可算】舞台芸術の主要演者、オーケストラの首席奏者"
      ...
      {
        "line": 166,
        "text": "【文法パターン】舞台芸術の主要演者を名詞で表す場合は `〈演者〉 + be + a principal`。オーケストラの役職は `the principal + be + the first player of 〈セクション〉`。  "
      },
      {
        "line": 191,
        "text": "4. 【名詞・金融／信託法】元金、元本、信託財産の元本"
      ...
      {
        "line": 199,
        "text": "【文法パターン】金融では `principal + be + the initial amount invested`／`principal + be + distinct from interest`。信託法では `trust principal + be + distinct from income`。  "
      },
      {
        "line": 229,
        "text": "5. 【名詞・可算・法律／代理関係】本人、依頼者、代理権を与える当事者"
      ...
      {
        "line": 279,
        "text": "【文法パターン】`the principal + be + directly responsible for 〈犯罪〉`  "
      },
      {
        "line": 299,
        "text": "7. 【名詞・可算・債務／保証法】主たる債務者・義務者、第一次的責任者"
      ...
      {
        "line": 307,
        "text": "【文法パターン】`the principal + be + primarily liable for 〈債務・義務〉`／`the principal + be + distinct from 〈surety/guarantor〉 with secondary liability`  "
      }
    ],
    "collocations_examples": [
      {
      ...
      {
        "line": 73,
        "text": "用途: `principal` を限定用法の形容詞として用い、舞台芸術で主要な役を担うダンサーを表す。  "
      },
      {
        "line": 74,
      ...
      {
        "line": 171,
        "text": "用途: 舞台芸術の文脈で、主要な役を担う演者を名詞 `principal` で表す。  "
      },
      {
        "line": 172,
        "text": "例: In this ballet company, she is a principal.  "
      },
      {
        "line": 173,
        "text": "訳: このバレエ団で、彼女は主要な役を担う演者である。  "
      },
      {
        "line": 175,
    ...
    "usage_notes": [
      ...
      {
        "line": 77,
        "text": "【語法・注意】`principal` と `principle` は綴りも意味も異なる。`principle` は「基本的な規則・法則」を表す名詞で、`principal` は「最も重要な」を表す形容詞にもなるため、両者を混同しない。  "
      },
      {
        "line": 125,
        "text": "2. 【名詞・可算】権限・主導的地位を持つ人；特に校長、学長"
      ...
      {
        "line": 180,
        "text": "【語法・注意】舞台芸術団体やオーケストラ内で確立した役割名として用い、一般の「重要人物」には広げない。  "
      },
      {
        "line": 191,
        "text": "4. 【名詞・金融／信託法】元金、元本、信託財産の元本"
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "776ea1b6ddf2815bce9c118149353f01e6d72ce0c65c78bec76e1f673ab47690",
    "source_first_artifact_sha256": "c139d76a10fe8ab9f7b9260af92633cbb87b421f5298d05c5786109fadd5d9e6",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
  ...
  "source_artifact_sha256": "c139d76a10fe8ab9f7b9260af92633cbb87b421f5298d05c5786109fadd5d9e6",
