...
This stage must be run by the exact same independent reviewer that completed stage 1: `reviewer.agent_id = /root/principal_cycle3_frame`, `declared_model = gpt-5`. Do not assign another reviewer and do not combine this task with another pass.

The response must be one `antonym_axis_adjudication_record_v1` JSON object and must be saved as `checker_recheck.frame-relation.stage2.response.json`. Preserve the same reviewer object, including `mode: "handoff"`, `ingested_by: "human"`, and the exact agent ID above.
...
```json
{
  ...
  "blind_request_sha256": "d5a9112aeaecb07821f244bd55fa01169406f690cdbf223b07a5f7cfb1e73457",
  "blind_record_sha256": "7bb761f968d23af93f54d25fddf40cbc153634e8438502cd9330d66222359621",
  "input_sections": {
    "sense_structure": [
      {
        "line": 40,
