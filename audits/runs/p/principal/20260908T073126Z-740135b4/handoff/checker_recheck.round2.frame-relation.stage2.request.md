...
This stage must be run by the exact same independent reviewer that completed round-2 stage 1: `reviewer.agent_id = /root/principal_cycle3_frame`, `declared_model = gpt-5`. Do not assign another reviewer and do not combine this task with another pass.

The response must be one `antonym_axis_adjudication_record_v1` JSON object and must be saved as `checker_recheck.round2.frame-relation.stage2.response.json`. Preserve the same reviewer object, including `mode: "handoff"`, `ingested_by: "human"`, and the exact agent ID above.
...
```json
{
  ...
  "blind_request_sha256": "b6b9ab3a1db146e974a3d0540da59779bd5c30f5e22e456c176f3079ca365109",
  "blind_record_sha256": "988e4f9ab414edc934825046529f4c54053e63f83abbf163428bddcf5f55dd68",
  "input_sections": {
    "sense_structure": [
      {
        "line": 40,
