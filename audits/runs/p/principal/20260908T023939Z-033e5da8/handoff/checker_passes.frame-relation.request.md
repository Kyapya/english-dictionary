...
```json
{
  ...
  "input_sections": {
    "antonym_items": [
      {
        "item_id": "ant-220cded44507",
        "headword": "principal",
        "sense_definition": "【日本語訳・定義】金融では、借入・貸付の元の金額、または投資された当初の金額で、そこから生じる利息・利益・収益とは区別される金額。返済文脈では、元金への支払いは未返済債務の基礎額を減らす。信託では、収益を生む財産本体または `corpus` を指し、そこから生じる収益と区別する。",
        "antonym": "interest",
        "antonym_definition": "定義: 借りた元金に対して支払う、または貸した・預けた元金から得る金額。"
      },
      {
        "item_id": "ant-285f80b0eaa6",
        "headword": "principal",
  ...
  "normalized_input_sha256": "2e539e4bf172a25aa56cf81eda128cb95d29847e01136991263185b0d1569aae"
}
```
