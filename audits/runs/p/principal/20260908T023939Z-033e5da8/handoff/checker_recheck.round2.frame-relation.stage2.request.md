...
Stage: `checker_recheck/round2/frame-relation-antonym-axis-stage2`

This stage must be run by the exact same independent reviewer that completed stage 1: `reviewer.agent_id = principal-clean-frame-relation-1`, `declared_model = gpt-5`. Do not assign another reviewer and do not combine this task with another pass.

The response must be one `antonym_axis_adjudication_record_v1` JSON object and must be saved as `recheck/round2/frame-relation.stage2.response.json`. Preserve the same reviewer object, including `mode: "handoff"`, `ingested_by: "human"`, and `agent_id: "principal-clean-frame-relation-1"`.
...
```json
{
  ...
  "blind_request_sha256": "f14e06c04b7721314396d4e55f3cac08b9b4fbde48911cddc0fc4a169aa9de29",
  "blind_record_sha256": "40338741ce20a0f79967160b9cc9258eeaa45607d8963b2035901da36f05a706",
  "input_sections": {
    "sense_structure": [
      {
        "line": 41,
