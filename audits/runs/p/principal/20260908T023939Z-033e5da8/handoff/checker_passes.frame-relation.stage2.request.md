...
This stage must be run by the exact same independent reviewer that completed stage 1: `reviewer.agent_id = principal-fresh-frame-relation-1`, `declared_model = gpt-5`. Do not assign another reviewer and do not combine this task with another pass.

The response must be one `antonym_axis_adjudication_record_v1` JSON object and must be saved as `checker_passes.frame-relation.stage2.response.json`. Preserve the same reviewer object, including `mode: "handoff"`, `ingested_by: "human"`, and `agent_id: "principal-fresh-frame-relation-1"`.
...
```json
{
  ...
  "blind_request_sha256": "61363a87390e72ffe9113ad719a31fb0abd1531207c1d2d4fc7b83877b568b0c",
  "blind_record_sha256": "fa2a196d76162f2688c726fe4c43a49a1c1827a1036d343eb9a130228cf47765",
  "input_sections": {
    "sense_structure": [
      {
        "line": 41,
    ...
    "frames": [
      ...
      {
        "line": 186,
        "text": "【文法パターン】この語義では `principal` を、指導的地位または主要な役割を持つ人を指す名詞として用いる。  "
      },
      {
        "line": 220,
        "text": "4. 【名詞・金融／信託】元金、元本、信託財産の本体"
    ...
    "collocations_examples": [
      ...
      {
        "line": 191,
        "text": "用途: 専門組織や舞台芸術で指導的地位または主要な役割を持つ人を名詞で指す。  "
      },
      {
        "line": 192,
        "text": "例: The concert program lists her as a principal.  "
      },
      {
        "line": 193,
        "text": "訳: そのプログラムには彼女が首席出演者として載っている。  "
      },
      {
        "line": 220,
        "text": "4. 【名詞・金融／信託】元金、元本、信託財産の本体"
