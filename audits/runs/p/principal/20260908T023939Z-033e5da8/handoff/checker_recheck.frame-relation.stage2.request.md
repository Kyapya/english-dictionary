...
Stage: `checker_recheck/frame-relation-antonym-axis-stage2`

This stage must be run by the exact same independent reviewer that completed stage 1: `reviewer.agent_id = principal-final-recheck-frame-relation-1`, `declared_model = gpt-5`. Do not assign another reviewer and do not combine this task with another pass.

The response must be one `antonym_axis_adjudication_record_v1` JSON object and must be saved as `recheck/frame-relation.stage2.response.json`. Preserve the same reviewer object, including `mode: "handoff"`, `ingested_by: "human"`, `agent_id: "principal-final-recheck-frame-relation-1"`, and `same_model_as_generation: true`.
...
```json
{
  ...
  "blind_request_sha256": "2d21e686ed83f976721741d109feccde7f1682bf57b41610d9a13326632300d7",
  "blind_record_sha256": "9d1dcd75cdaa7bb635e01ed9bebd4791fb6880ecbbc79ea60291f3a7dd9d022c",
  "input_sections": {
    "sense_structure": [
      {
        "line": 41,
