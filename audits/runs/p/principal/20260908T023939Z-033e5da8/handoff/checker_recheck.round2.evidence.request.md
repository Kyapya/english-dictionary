...
Save exactly one JSON response as `recheck/round2/evidence.response.json`. The top-level JSON must include the routed `pass_id` and a `reviewer` object with `mode: "handoff"`, the actual `declared_model`, `ingested_by: "human"`, and a non-empty `agent_id`. Each checker pass must use a different agent_id.
## Prompt
...
```json
{
  ...
  "input_body_sha256": "812af2465113a97f27b502f17984e7e043ee862f484964f04a7d118d6f72aced",
  "input_sections": {
    "pronunciation": [
      {
        "line": 13,
    ...
    "frequency_register": [
      ...
      {
        "line": 219,
        "text": "【レジスター/領域】金融、融資、投資、会計、信託。日常的なローン説明にも現れる。  "
      },
      {
        "line": 270,
        "text": "5. 【名詞・可算・法律／代理関係】本人、依頼者、代理権を与える当事者"
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "18891bae678a4f99e651c4e0c62725d90e95361489de38cc8a428b392c6ba5e9",
    "source_first_artifact_sha256": "73206c4356f34b1227178ef9b9aa91ef4d19dc7cfe6350aec19b6b06db9cb8c8",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
  ...
  "source_artifact_sha256": "73206c4356f34b1227178ef9b9aa91ef4d19dc7cfe6350aec19b6b06db9cb8c8",
  "normalized_input_sha256": "d6b3801db12a423f8b9f466fe81329a3e4aeed1f40d4b6070d93dd254e3cbc39"
}
```
