...
Stage: `checker_recheck/evidence`
...
Save exactly one JSON response as `recheck/evidence.response.json`. The top-level JSON must include the routed `pass_id` and a `reviewer` object with `mode: "handoff"`, the actual `declared_model`, `ingested_by: "human"`, and a non-empty `agent_id`. Each checker pass must use a different agent_id.
## Prompt
...
```json
{
  ...
  "input_sections": {
    ...
    "core_image": [
      ...
      {
        "line": 33,
        "text": "・専門組織の正式な上級地位または舞台芸術の首席を占める人 → 「上級責任者、首席出演者・奏者」（語義3）  "
      },
      {
        "line": 34,
    ...
    "sense_structure": [
      ...
      {
        "line": 178,
        "text": "3. 【名詞・可算】専門組織の上級責任者、舞台芸術の首席出演者・奏者"
      },
      {
        "line": 180,
        "text": "【日本語訳・定義】分野ごとに確立した上級地位や首席の役割を持つ人。企業・専門組織で支配権または指導的地位を持つ人や、バレエ団・オペラ団の首席出演者、オーケストラのセクションを率いる奏者などを指し、重要人物一般の呼称ではない。  "
      },
      {
        "line": 213,
      ...
      {
        "line": 215,
        "text": "【日本語訳・定義】金融では、借入・貸付・投資で利息・利益・収益と区別される資本部分を指す。当初の元本金額を指す場合と、返済を反映した現在の未返済元金を指す場合があり、元金への支払いは未返済債務の基礎額を減らす。信託では、収益を生む財産本体または `corpus` を指し、そこから生じる収益と区別する。  "
      },
      {
        "line": 270,
    ...
    "frequency_register": [
      ...
      {
        "line": 132,
        "text": "【レジスター/領域】標準語。米国・カナダなどでは小中高校の「校長」に一般的。イングランドでは学校の長には `head teacher` または `head` が一般的で、`principal` はカレッジなど特定の教育機関の長に使われることがある。  "
      },
      {
        "line": 178,
        "text": "3. 【名詞・可算】専門組織の上級責任者、舞台芸術の首席出演者・奏者"
    ...
    "frames": [
      ...
      {
        "line": 134,
        "text": "【文法パターン】`the principal of 〈限定詞を含む学校・教育機関の名詞句〉`＝～の校長・学長／`a school principal`＝学校の校長／`a college principal`＝カレッジの学長  "
      },
      {
        "line": 178,
        "text": "3. 【名詞・可算】専門組織の上級責任者、舞台芸術の首席出演者・奏者"
      ...
      {
        "line": 186,
        "text": "【文法パターン】この語義では `principal` を、分野固有の上級地位または首席の役割を持つ人を指す名詞として用いる。  "
      },
      {
        "line": 213,
        "text": "4. 【名詞・金融／信託】元金、元本、信託財産の本体"
      ...
      {
        "line": 325,
        "text": "【文法パターン】`a principal in a crime`＝犯罪について `principal` とされる関与者／`treat someone as a principal`＝人を `principal` として扱う／`a principal in the first/second degree`＝歴史的分類上の第一級・第二級 `principal`  "
      },
      {
        "line": 355,
        "text": "7. 【名詞・可算・債務／保証法】主たる債務者・義務者、第一次的責任者"
    ...
    "collocations_examples": [
      ...
      {
        "line": 340,
        "text": "用途: 歴史的なコモンローで、第一級 `principal` という分類を表す。  "
      },
      {
        "line": 341,
      ...
      {
        "line": 342,
        "text": "訳: その古い判決は被告人を第一級 `principal` に分類した。  "
      },
      {
        "line": 355,
        "text": "7. 【名詞・可算・債務／保証法】主たる債務者・義務者、第一次的責任者"
    ...
    "usage_notes": [
      ...
      {
        "line": 344,
        "text": "【語法・注意】刑事法の `principal` は適用される法的分類に従う役割名で、`accessory` と対比される。日本法上の「正犯」と範囲が必ず一致するとは限らない。債務・保証関係の第一次的責任者は別の語義7である。  "
      },
      {
        "line": 355,
        "text": "7. 【名詞・可算・債務／保証法】主たる債務者・義務者、第一次的責任者"
    ...
    "lexical_relations": [
      ...
      {
        "line": 160,
        "text": "違い: 主にイングランドで学校の「校長」に使う。`principal` は北米などで一般的で、イングランドではカレッジ等の長を指す場合がある。  "
      },
      {
        "line": 161,
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "e3685b9ba5e3c2fc6d7cdf71d647923a85beb7ad6f6798fd6345132aae945789",
    "source_first_artifact_sha256": "ff24a17ea8b512942ddc43782619b29ae25781f38739f58c34321e6099863bcb",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
    ...
    "claim_units": [
      ...
      },
      {
        ...
        "statement": "Financial principal is the underlying borrowed, lent, or invested amount, whether the original amount or the current outstanding amount after principal repayments, distinct from interest and returns.",
        "article_target_ids": [
          "definition:004",
          "grammar_pattern:004",
          "usage_note:001",
      ...
      },
      {
        ...
        "subject_form": "principal",
        "claim_type": "specialist_use",
        "statement": "Criminal-law principal denotes a participant treated as a principal under the applicable legal classification and contrasted with an accessory; its scope need not match the Japanese-law category 正犯.",
        "article_target_ids": [
          "definition:006",
          "grammar_pattern:006",
          "usage_note:006"
  ...
  "normalized_input_sha256": "515efe3d616671f7085604a73ea1bf2acf2aa33e8fd30eb155cad0b46ab6dc08"
}
```
