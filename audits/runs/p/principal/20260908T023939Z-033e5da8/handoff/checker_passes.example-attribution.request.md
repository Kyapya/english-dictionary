...
```json
{
  ...
  "input_sections": {
    "sense_structure": [
      ...
      },
      {
        ...
        "definition": "金融では、借入・貸付の元の金額、または投資された当初の金額で、そこから生じる利息・利益・収益とは区別される金額。返済文脈では、元金への支払いは未返済債務の基礎額を減らす。信託では、収益を生む財産本体または `corpus` を指し、そこから生じる収益と区別する。"
      },
      {
        "sense_id": "sense:005",
        "line": 277,
  ...
  "normalized_input_sha256": "4163c82e2099bb9607b394953d04105c449a2e4e87e7ecf5cef66329af2ff782"
}
```
