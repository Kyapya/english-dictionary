...
This stage must be executed by the same frame-relation agent from stage 1: reviewer.agent_id=`/root/finish_principal/frame3`, declared_model=`Codex (inherited session model)`.
...
```json
{
  ...
  "blind_request_sha256": "bce84e1c51487b094db76812c6c2d62709aef7dc9dd0010866441b96264ed182",
  "blind_record_sha256": "3d8fcf93f3833fb81ebc4ee619f9181e6114ea893246ffddba782c5fb03eabac",
  "input_sections": {
    "sense_structure": [
      {
        "line": 41,
    ...
    "antonym_axis_items": [
      {
        ...
        "stage1_axis": {
          ...
          "axis": "順位",
          "relation_type": "程度",
          "reason": "principalの最上位または高位とsecondaryの二次的な順位が同一軸上で対立する。"
        },
        "sense_id": "sense:001",
        "anchor": {
      ...
      },
      {
        ...
        "stage1_axis": {
          ...
          "axis": "重要性",
          "relation_type": "程度",
          "reason": "principalの高い重要性とminorの低い重要性が同一軸上で対立する。"
        },
        "sense_id": "sense:001",
        "anchor": {
          "section": "lexical_relations",
