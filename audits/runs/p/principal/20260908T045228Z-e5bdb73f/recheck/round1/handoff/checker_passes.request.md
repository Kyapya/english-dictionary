...
Parallel execution does not pause the workflow guard: keep the normal heartbeat/checkpoint discipline while the agents are running. Time targets are advisory; stop rather than silently restarting only if a non-time budget is exhausted.
