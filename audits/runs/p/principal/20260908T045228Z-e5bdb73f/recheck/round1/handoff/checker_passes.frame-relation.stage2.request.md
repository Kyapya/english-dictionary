...
This stage must be executed by the same frame-relation agent from stage 1: reviewer.agent_id=`/root/principal_finish/frame`, declared_model=`Codex (inherited session model)`.
...
```json
{
  ...
  "blind_record_sha256": "2509e34816da4107e52c9d6ac169baa63bbea8aa5076ad8299ee1dad15b823a6",
  "input_sections": {
    "sense_structure": [
      {
        "line": 41,
