...
```json
{
  ...
  "input_sections": {
    ...
    "sense_structure": [
      ...
      {
        "line": 128,
        "text": "【日本語訳・定義】組織・事業・交渉などで主導的地位を持つ人、または行為・取引の主要な当事者。権限を持つ人を指すことが多いが、組織を支配することを必須とはしない。特に教育では、学校、カレッジ、その他の教育機関を管理する最高責任者を指す。教育上どの種類の機関を指すかは地域と制度によって異なる。  "
      },
      {
        "line": 169,
    ...
    "frames": [
      ...
      {
        "line": 134,
        "text": "【文法パターン】可算名詞として、組織・活動の主要人物や取引の当事者を指す。`act as principal` は取引の当事者本人の資格で行動することを表す。教育文脈では学校・カレッジなどの長を表す役職名として用いる。  "
      },
      {
        "line": 169,
        "text": "3. 【名詞・金融／信託法】元金、元本、信託財産の元本"
      ...
      {
        "line": 177,
        "text": "【文法パターン】金融では利息・収益の基礎となる金額を、信託法では収益と区別される財産本体を表す名詞として用いる。  "
      },
      {
        "line": 212,
        "text": "4. 【名詞・可算・法律／代理関係】本人、依頼者、代理権を与える当事者"
      ...
      {
        "line": 253,
        "text": "【文法パターン】可算名詞として、舞台芸術・音楽で確立した主要演者や首席奏者の役割を表す。  "
      },
      {
        "line": 273,
        "text": "6. 【名詞・可算・刑事法】適用法上 `principal` と分類される犯罪関与者"
      ...
      {
        "line": 281,
        "text": "【文法パターン】刑事法で可算名詞として用い、犯罪関与者を適用される法的分類に従って指す。  "
      },
      {
        "line": 306,
        "text": "7. 【名詞・可算・債務／保証法】主たる債務者・義務者、第一次的責任者"
      ...
      {
        "line": 314,
        "text": "【文法パターン】可算名詞として、保証人・`surety`・`guarantor` と対比される第一次的責任者を指す。  "
      }
    ],
    "collocations_examples": [
      {
      ...
      {
        "line": 154,
        "text": "用途: 他者の代理人としてだけではなく、取引の当事者本人の資格で行動することを表す。  "
      },
      {
        "line": 155,
        "text": "例: In this transaction, the firm acts as principal, buying the goods for its own account rather than as another company's agent.  "
      },
      {
        "line": 156,
        "text": "訳: この取引では、その会社は当事者本人として行動し、別会社の代理人としてではなく自己の勘定で商品を購入する。  "
      },
      {
        "line": 169,
        "text": "3. 【名詞・金融／信託法】元金、元本、信託財産の元本"
    ...
    "usage_notes": [
      ...
      {
        "line": 158,
        "text": "【語法・注意】一般の「重要人物」を自由に指す語ではなく、特定の組織・活動・取引で主要な立場にある人や当事者に用いる。取引の `principal` は当事者本人の立場を示し、自分が代理人を任命していることを必須としない。代理人との関係で権限の源となる本人は語義4で詳しく扱う。教育上の役職名は地域や制度によって異なるため、日本語の「校長」を機械的にすべて `principal` としない。  "
      },
      {
        "line": 169,
        "text": "3. 【名詞・金融／信託法】元金、元本、信託財産の元本"
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "1f7c9f5153dbb7b0f1429417af9cfcd1bb81890c5e1eb390a768f3749f941dce",
    "source_first_artifact_sha256": "c4f9a40250cfee21fff7a9d7cc927d0ef68739f3eb7aef30dc95defd63e42948",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
  ...
  "normalized_input_sha256": "3de4965300ff2cb36cd9651e76c72650438c2a929e8e582867d44f331080c3bd"
}
```
