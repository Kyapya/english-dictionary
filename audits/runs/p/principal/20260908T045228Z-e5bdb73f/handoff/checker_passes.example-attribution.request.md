...
```json
{
  ...
  "input_sections": {
    "sense_structure": [
      ...
      },
      {
        ...
        "definition": "オーケストラで一つのセクションを率いる奏者。重要人物一般の呼称ではない。"
      },
      {
        "sense_id": "sense:004",
        "line": 192,
        "label": "4. 【名詞・金融】元金、元本",
        "definition": "借入・貸付・投資で利息・利益・収益と区別される元の資本額を指す。元金への支払いは債務額を減らす。"
      },
      {
        "sense_id": "sense:005",
        "line": 244,
  ...
  "normalized_input_sha256": "f78e3036bfe193e0b55764f52f456fe99b387f2ebb2fdda1fe85574fe4723113"
}
```
