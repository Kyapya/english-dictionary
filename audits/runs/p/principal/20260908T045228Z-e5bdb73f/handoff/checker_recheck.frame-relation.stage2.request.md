...
This stage must be run by the exact same independent reviewer that completed stage 1: `reviewer.agent_id = principal-fresh2-frame-relation-recheck1`, `declared_model = gpt-5`. Do not assign another reviewer and do not combine this task with another pass.

The response must be one `antonym_axis_adjudication_record_v1` JSON object and must be saved as `recheck/frame-relation.stage2.response.json`. Preserve the same reviewer object, including `mode: "handoff"`, `ingested_by: "human"`, and `agent_id: "principal-fresh2-frame-relation-recheck1"`.
...
```json
{
  ...
  "blind_request_sha256": "37141948fe9fe73f832a6bd34a9d6a00a7cb634b2f1ae3c30b480bf94e3d1bcb",
  "blind_record_sha256": "46a4631329c5f3cca009aa8bc57ca3e1133055566877fee41ee0cef7cea57550",
  "input_sections": {
    "sense_structure": [
      {
        "line": 41,
    ...
    "frames": [
      ...
      {
        "line": 134,
        "text": "【文法パターン】可算名詞として、組織上の権限・地位を持つ人を指す。教育文脈では学校・カレッジなどの長を表す役職名として用いる。  "
      },
      {
        "line": 164,
        "text": "3. 【名詞・可算】舞台芸術の主要演者、オーケストラの首席奏者"
    ...
    "collocations_examples": [
      ...
      {
        "line": 325,
        "text": "訳: その契約の下で、会社はその債務について主たる当事者として責任を負い、保証人は二次的にのみ責任を負う。  "
      },
      {
        "line": 327,
