...
```json
{
  ...
  "input_sections": {
    ...
    "core_image": [
      ...
      {
        "line": 33,
        "text": "・オーケストラのセクションを率いる奏者 → 「首席奏者」（語義3）  "
      },
      {
        "line": 34,
        "text": "・利息・収益の土台となる金額 → 「元金、元本」（語義4）  "
      },
      {
        "line": 35,
    ...
    "sense_structure": [
      ...
      {
        "line": 166,
        "text": "【日本語訳・定義】オーケストラで一つのセクションを率いる奏者。重要人物一般の呼称ではない。  "
      },
      {
        "line": 192,
        "text": "4. 【名詞・金融】元金、元本"
      ...
      {
        "line": 194,
        "text": "【日本語訳・定義】借入・貸付・投資で利息・利益・収益と区別される元の資本額を指す。元金への支払いは債務額を減らす。  "
      },
      {
        "line": 244,
    ...
    "frequency_register": [
      ...
      {
        "line": 132,
        "text": "【レジスター/領域】標準語。学校・教育機関の長を表し、イングランドではカレッジの長を指す場合がある。  "
      },
      {
        "line": 164,
        "text": "3. 【名詞・可算】オーケストラの首席奏者"
      ...
      {
        "line": 198,
        "text": "【レジスター/領域】金融、融資、投資、会計。日常的なローン説明にも現れる。  "
      },
      {
        "line": 244,
        "text": "5. 【名詞・可算・法律／代理関係】本人、依頼者、代理権を与える当事者"
    ...
    "frames": [
      ...
      {
        "line": 172,
        "text": "【文法パターン】`one of 〈オーケストラなどの所有格〉 principals`＝その団体の首席奏者の一人  "
      },
      {
        "line": 192,
        "text": "4. 【名詞・金融】元金、元本"
      ...
      {
        "line": 200,
        "text": "【文法パターン】`principal and interest`＝元金と利息／`pay down the principal`＝元金を減らす／`repay principal`＝元金を返済する／`protect the principal`＝元本を保全する  "
      },
      {
        "line": 244,
        "text": "5. 【名詞・可算・法律／代理関係】本人、依頼者、代理権を与える当事者"
    ...
    "usage_notes": [
      ...
      {
        "line": 153,
        "text": "【語法・注意】地域や制度によって対応する役職名が異なるため、日本語の「校長」を機械的にすべて `principal` としない。  "
      },
      {
        "line": 164,
        "text": "3. 【名詞・可算】オーケストラの首席奏者"
      ...
      {
        "line": 181,
        "text": "【語法・注意】オーケストラ内で確立した役割名として用いる。  "
      },
      {
        "line": 192,
        "text": "4. 【名詞・金融】元金、元本"
      ...
      {
        "line": 224,
        "text": "【語法・注意】`principal` は元の基礎額、`interest` は借入の対価または貸付・投資から生じる収益であり、同じ金額を指さない。`repay the principal` では `principal` 自体が目的語の名詞になる。日本語の「元利金」は `principal and interest` であり、`principal interest` とはしない。  "
      },
      {
        "line": 244,
        "text": "5. 【名詞・可算・法律／代理関係】本人、依頼者、代理権を与える当事者"
    ...
    "lexical_relations": [
      ...
      {
        "line": 160,
        "text": "違い: `head` は組織の長を広く表すが、`principal` は教育機関で用いられる役職名である。  "
      },
      {
        "line": 161,
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "9e3a406d3ba2be50288863fba45f0fb1f42178ba0641d23eaf409c4e7b858189",
    "source_first_artifact_sha256": "503d16ee7edb78a4201620a2bf0d2d1b5bc70be5b9eb3b32078fdb8109dc4abb",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
  ...
  "source_artifact_sha256": "503d16ee7edb78a4201620a2bf0d2d1b5bc70be5b9eb3b32078fdb8109dc4abb",
  "normalized_input_sha256": "6ad701b2746524549f11d05415889ef45217e2cc68410567d89f688635e93484"
}
```
