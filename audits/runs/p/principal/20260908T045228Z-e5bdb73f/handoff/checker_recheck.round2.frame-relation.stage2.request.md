...
This stage must be run by the exact same independent reviewer that completed stage 1: `reviewer.agent_id = principal-fresh2-frame-relation-recheck2`, `declared_model = gpt-5`. Do not assign another reviewer and do not combine this task with another pass.

The response must be one `antonym_axis_adjudication_record_v1` JSON object and must be saved as `recheck/round2/frame-relation.stage2.response.json`. Preserve the same reviewer object, including `mode: "handoff"`, `ingested_by: "human"`, and `agent_id: "principal-fresh2-frame-relation-recheck2"`.
...
```json
{
  ...
  "blind_request_sha256": "2802b8bf63e0c548a960cbf484848cac06b408d52ee7959dc3190249a80eb04d",
  "blind_record_sha256": "bddf7662ef827279b1bd761e8f082072315ffed83af87297eeed9e6c5ba8258e",
  "input_sections": {
    "sense_structure": [
      {
        "line": 40,
