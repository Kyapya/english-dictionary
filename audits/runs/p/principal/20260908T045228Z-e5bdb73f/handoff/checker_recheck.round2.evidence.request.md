...
```json
{
  ...
  "input_sections": {
    ...
    "core_image": [
      ...
      {
        "line": 29,
        "text": "`principal` の中心は、「重要度・権限・責任・金額の土台として第一に位置する」である。形容詞では主要なものを選び出し、名詞では教育機関の長、オーケストラの首席奏者、利息・収益に対する元の金額や信託収益に対する財産本体、法的関係の主要当事者を指す。  "
      },
      {
        "line": 30,
      ...
      {
        "line": 31,
        "text": "・教育機関で管理責任を負う長 → 「校長、学長」（語義2）  "
      },
      {
        "line": 32,
        "text": "・オーケストラで一つのセクションを率いる奏者 → 「首席奏者」（語義3）  "
      },
      {
        "line": 33,
    ...
    "frames": [
      ...
      {
        "line": 128,
        "text": "【文法パターン】`the principal of 〈限定詞を含む学校・教育機関の名詞句〉`／`a school principal`／`a college principal`  "
      },
      {
        "line": 158,
        "text": "3. 【名詞・可算】オーケストラの首席奏者"
      ...
      {
        "line": 166,
        "text": "【文法パターン】`one of 〈オーケストラを表す所有格〉 principals`  "
      },
      {
        "line": 186,
        "text": "4. 【名詞・金融／信託法】元金、元本、信託財産の元本"
    ...
    "usage_notes": [
      ...
      {
        "line": 147,
        "text": "【語法・注意】教育上の役職名は地域や制度によって異なるため、日本語の「校長」を機械的にすべて `principal` としない。  "
      },
      {
        "line": 158,
        "text": "3. 【名詞・可算】オーケストラの首席奏者"
      ...
      {
        "line": 175,
        "text": "【語法・注意】オーケストラ内で確立した役割名として用い、一般の「重要人物」には広げない。  "
      },
      {
        "line": 186,
        "text": "4. 【名詞・金融／信託法】元金、元本、信託財産の元本"
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "0b73930fe939bcb8f967d5ef789f93305f226bd8e259ce8a1aec215f0e67931d",
    "source_first_artifact_sha256": "c67fbd1790a51734d06c4ce7bf5e479b9b6d376b3161f9cb216d7d37a456a218",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
  ...
  "normalized_input_sha256": "d527b2132c6b6fb477661176a158e80faea28eb871d7009717cf9c487ff22bf2"
}
```
