...
This stage must be run by the exact same independent reviewer that completed stage 1: `reviewer.agent_id = principal-round2-frame-relation-1`, `declared_model = gpt-5`. Do not assign another reviewer and do not combine this task with another pass.

The response must be one `antonym_axis_adjudication_record_v1` JSON object and must be saved as `recheck/round2/frame-relation.stage2.response.json`. Preserve the same reviewer object, including `mode: "handoff"`, `ingested_by: "human"`, and `agent_id: "principal-round2-frame-relation-1"`.
...
```json
{
  ...
  "blind_request_sha256": "a9752bd0c29f43d4ac32e877269fd4810a50de8d93b03cbbabe6146fc8f6e9cf",
  "blind_record_sha256": "fe5cbd2b0427389ed37da876049be2bacf72fc17317e993b9ddca58f953e9ae6",
  "input_sections": {
    "sense_structure": [
      {
        "line": 41,
