...
```json
{
  ...
  "input_sections": {
    "sense_structure": [
      ...
      },
      {
        ...
        "definition": "専門業務や舞台芸術などで、指導的地位または主要な役割を持つ人。企業・専門組織の上級責任者や、バレエ団・オペラ団の首席出演者、オーケストラのセクションを率いる奏者などを指す。"
      },
      {
        "sense_id": "sense:004",
        "line": 240,
      ...
      },
      {
        ...
        "definition": "別の人・法人である `agent` に、自分のために行動する権限を与える人または法人。代理人は本人のために行動し、代理関係では `principal` が権限の源となる。"
      },
      {
        "sense_id": "sense:006",
        "line": 356,
        "label": "6. 【名詞・可算・刑事法】正犯、犯罪の主要関与者",
    ...
    "collocations_examples": [
      ...
      {
        "example_id": "ex-c78097c7ddaf",
        "example": "After payment, the surety sought to recover from the principal.",
        "translation": "支払い後、保証人は主たる義務者からの償還を求めた。"
      },
      {
        "example_id": "ex-2c2e3f467b14",
  ...
  "normalized_input_sha256": "3eeede04cfa1aabdfece033d1632269c9b517914f3b025aeadcfef11a1981416"
}
```
