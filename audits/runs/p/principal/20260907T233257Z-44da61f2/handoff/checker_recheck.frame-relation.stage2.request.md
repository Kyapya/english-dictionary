...
This stage must be run by the exact same independent reviewer that completed stage 1: `reviewer.agent_id = principal-recheck-frame-relation-1`, `declared_model = gpt-5`. Do not assign another reviewer and do not combine this task with another pass.

The response must be one `antonym_axis_adjudication_record_v1` JSON object and must be saved as `recheck/frame-relation.stage2.response.json`. Preserve the same reviewer object, including `mode: "handoff"`, `ingested_by: "human"`, and `agent_id: "principal-recheck-frame-relation-1"`.
...
```json
{
  ...
  "blind_request_sha256": "2ec279a999ec89f84efcbf3136f0be91f17131fdab61c6c51ddad812993184c7",
  "blind_record_sha256": "683387cc99beade1d9270a0d8fe4a5739acac23aa74b62ba4ef02f157a72cadc",
  "input_sections": {
    "sense_structure": [
      {
        "line": 41,
