...
```json
{
  ...
  "input_sections": {
    ...
    "frames": [
      ...
      {
        "line": 402,
        "text": "【文法パターン】`be liable as principal`＝主たる当事者として責任を負う／`the obligation of the principal`＝主たる義務者の義務／`recover from the principal`＝主たる義務者から回収する／`the principal and the surety`＝主たる義務者と保証人  "
      }
    ],
    "collocations_examples": [
      {
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "8a34172c0f8edf7b6fe23c72ee4d1a0d07beb53ae79ffac4a111f6be42707770",
    "source_first_artifact_sha256": "aa1779766eda8637c5e7e020ab81117c845bedfb53b9b4eeae14ec9df7732826",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
    ...
    "claim_units": [
      ...
      },
      {
        ...
        "statement": "Principalship denotes the office or position of a principal.",
        "article_target_ids": [
          "word_formation:002"
        ],
        "source_supports": [
  ...
  "normalized_input_sha256": "bca834bb9ba526d19ee771a7b0c4f9e0b4f31fe434bbc129b8d1fd6e7251fffa"
}
```
