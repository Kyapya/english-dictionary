...
```json
{
  ...
  "input_sections": {
    "pronunciation": [
      ...
      {
        "line": 15,
        "text": "米・英: /ˈprɪnsəpəl/。3音節の PRIN-ci-pal で、第1音節に主強勢がある。第2・第3音節の母音はいずれも弱い /ə/ で、語末の `-pal` を強く /pæl/ と読まない。`principle` も通常まったく同じ /ˈprɪnsəpəl/ なので、音だけでは区別できない。  "
      }
    ],
    "etymology": [
      {
    ...
    "word_formation": [
      ...
      {
        "line": 24,
        "text": "・principally：副詞。「主として、主に」の意味で、`mainly` よりやや形式的に響くことがある。  "
      },
      {
        "line": 25,
        "text": "・principalship：名詞。校長・学長など `principal` の職、任期、地位を表す。  "
      },
      {
        "line": 26,
        "text": "・principal-agent：複合形。法律・経済学で、本人と代理人、または依頼者と代理人の関係を表す。  "
      }
    ],
    "core_image": [
      {
      ...
      {
        "line": 30,
        "text": "`principal` の中心は、「重要度・権限・責任・金額の土台として第一に位置する」である。形容詞では最重要のものを選び出し、名詞では組織や行為の中心人物、利息に対する元の金額、代理関係などの主要当事者を指す。  "
      },
      {
        "line": 31,
      ...
      {
        "line": 36,
        "text": "・犯罪・債務で第一義的責任を負う当事者 → 「正犯、主たる債務者」（語義6）  "
      }
    ],
    "sense_structure": [
      {
    ...
    "usage_notes": [
      ...
      {
        "line": 214,
        "text": "【語法・注意】この語義の `principal` は、組織ごとに意味する階級・権限が異なる肩書きでもある。`a principal at a consulting firm` を必ず「社長」と訳すのは誤りで、文脈に応じて「共同経営者」「上級責任者」などと訳す。`principal dancer` の `principal` は形容詞的に名詞を修飾しているため、「首席という地位の人」を指す名詞単独の `a principal` と構造を区別する。  "
      },
      {
        "line": 239,
        "text": "4. 【名詞・不可算を中心に可算用法もある】元金、元本、利息計算の基礎額"
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "b5e0edca86c3b4c886de0c8710c266bc6720e620da293676d9dfd94dd8d5f976",
    "source_first_artifact_sha256": "716ae619355b7e599eb5e976d897049d038933873f4f3902aa220ecdbdddd065",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
    ...
    "sources": [
      {
        ...
        "facts": [
          ...
          },
          {
            ...
            "form": "principalship",
            "kind": "derived_form",
            "statement": "Principalship is the noun formed for the office or position of a principal.",
    ...
    "source_union": [
      ...
      },
      {
        ...
        "disposition": "included",
        "rationale": "Major person noun and education title with regional qualification."
      },
      {
        "id": "U-003",
        "source_fact_ids": [
        ...
        "canonical_statement": "Principal can denote a leading person or performer, including a principal artist or orchestral section leader.",
        "disposition": "included",
        "rationale": "Established professional and performing-arts noun use."
      },
      {
        "id": "U-004",
        "source_fact_ids": [
      ...
      },
      {
        ...
        "canonical_statement": "Principalship is the derived noun for the office or position of a principal.",
        "disposition": "included",
        "rationale": "Useful transparent role derivative."
      },
      {
        "id": "U-012",
        "source_fact_ids": [
        ...
        "canonical_statement": "Principally is the corresponding adverb meaning chiefly or mainly.",
        "disposition": "included",
        "rationale": "High-value common derivative."
      },
      {
        "id": "U-013",
        "source_fact_ids": [
        ...
        "canonical_statement": "Principal and principle are homophonous but differ in spelling, parts of speech, and current meanings.",
        "disposition": "included",
    ...
    "claim_units": [
      {
        ...
        "statement": "The adjective means principal, main, or first in relative importance and is chiefly used before a noun.",
        "article_target_ids": [
          "definition:001",
          "grammar_pattern:001",
          "usage_note:001"
      ...
      },
      {
        ...
        "subject_form": "principal",
        "claim_type": "lexical_sense",
        "statement": "Principal can be a leading professional, participant, performer, or orchestral section player.",
        "article_target_ids": [
          "definition:003",
          "grammar_pattern:003"
        ],
        "source_supports": [
          ...
          },
          {
            ...
            "support_summary": "Etymonline records the historical chief-person and leading-representative noun."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "claim_type": "specialist_use",
        "statement": "An agency principal gives authority to an agent acting on its behalf, with legal effects dependent on the authority and governing law.",
        "article_target_ids": [
          "definition:005",
          "grammar_pattern:005",
          "usage_note:005",
      ...
      },
      {
        ...
        "statement": "Principalship denotes the office, position, or tenure of a principal.",
        "article_target_ids": [
          "word_formation:002"
        ],
        "source_supports": [
      ...
      },
      {
        ...
        "claim_type": "derived_form",
        "statement": "Principally is the corresponding adverb, commonly meaning mainly or chiefly.",
        "article_target_ids": [
          "word_formation:001"
        ],
        "source_supports": [
  ...
  "normalized_input_sha256": "f53b89a8ebc72c158fb5bc80cb59aa7ff5b032c4b473bd19e2c844c93516d513"
}
```
