  ...
  "requests": [
    {
      ...
      "input_body_sha256": "c96b432f7722146273be218a4cf0e6ac1b8e8c4438707612299c09750a7abcd7",
      "input_sections": {
        "definitions": [
          {
            "line": 43,
          ...
          {
            "line": 219,
            "text": "【日本語訳・定義】人・会社・組織などが所有・占有・使用する土地、建物、建物の一部、およびそれに付随する敷地。会社・店舗・学校・病院・工場などの場所に特によく使うが、住宅や賃貸物件などにも使える。現代英語ではこの意味を通常 `premises` という複数形で表す。単数の `a premise` / `one premise` がこの意味で使われる例も、とくに法務・規制・不動産管理などの文脈にはあるが、一般的な用法では `a building`、`a property`、`a site` のほうが自然なことが多い。  "
          },
          {
            "line": 281,
    ...
    },
    {
      ...
      "input_sections": {
        "core_image": [
          ...
          {
            "line": 39,
            "text": "`premises` の「建物・敷地」という用法は歴史的には同じ語から発達したが、現代話者にとって上のコアイメージから直接推測しにくい定着義なので、別に覚える。 名詞の「前提」と「前提命題」は同じ中心概念を共有し、論理学では後者の専門的な枠組みとして現れる。動詞の二つの説明も、同じ「前提を置く」という核を目的語の取り方の違いから整理したものである。  "
          }
        ],
        "sense_structure": [
          {
      ...
      "input_sections": {
        "sense_structure": [
          ...
          },
          {
            ...
            "definition": "人・会社・組織などが所有・占有・使用する土地、建物、建物の一部、およびそれに付随する敷地。会社・店舗・学校・病院・工場などの場所に特によく使うが、住宅や賃貸物件などにも使える。現代英語ではこの意味を通常 `premises` という複数形で表す。単数の `a premise` / `one premise` がこの意味で使われる例も、とくに法務・規制・不動産管理などの文脈にはあるが、一般的な用法では `a building`、`a property`、`a site` のほうが自然なことが多い。"
          },
          {
            "sense_id": "sense:005",
            "line": 281,
