    ...
    "antonym_items": [
      {
        ...
        "headword": "tentative",
        "sense_definition": "【日本語訳・定義】計画、日程、合意、結論、説明、提案、識別などが、現時点では候補として置かれているものの、検討・交渉・確認が終わっておらず、後で変更または撤回される可能性があることを表す。単に「一時的」という期間の短さではなく、内容の確定性がまだ低いことに焦点がある。",
        "antonym": "confirmed",
        "antonym_definition": "定義: 確認や承認によって、正しいもの・正式なものとして確定している。"
      },
      {
        "item_id": "ant-870b6cb24167",
        "headword": "tentative",
        "sense_definition": "【日本語訳・定義】人の行動、声、表情、返答、提案などが、確信や自信を十分に示さず、様子をうかがいながら慎重に行われることを表す。単に静か・弱いという意味ではなく、失敗や拒否を恐れている、またはまだ慣れていないような不確かさが表れやすい。",
        "antonym": "decisive",
        "antonym_definition": "定義: 迷わず判断し、行動をはっきり決める。"
      },
      {
        ...
        "sense_definition": "【日本語訳・定義】人の行動、声、表情、返答、提案などが、確信や自信を十分に示さず、様子をうかがいながら慎重に行われることを表す。単に静か・弱いという意味ではなく、失敗や拒否を恐れている、またはまだ慣れていないような不確かさが表れやすい。",
        "antonym": "confident",
        "antonym_definition": "定義: 自分の能力・判断・発言に確信を持っている。"
      },
      {
        ...
        "sense_definition": "【日本語訳・定義】人の行動、声、表情、返答、提案などが、確信や自信を十分に示さず、様子をうかがいながら慎重に行われることを表す。単に静か・弱いという意味ではなく、失敗や拒否を恐れている、またはまだ慣れていないような不確かさが表れやすい。",
        "antonym": "assured",
        "antonym_definition": "定義: 落ち着きと自信があり、確実そうに見える。"
      },
      {
        ...
        "sense_definition": "【日本語訳・定義】計画、日程、合意、結論、説明、提案、識別などが、現時点では候補として置かれているものの、検討・交渉・確認が終わっておらず、後で変更または撤回される可能性があることを表す。単に「一時的」という期間の短さではなく、内容の確定性がまだ低いことに焦点がある。",
        "antonym": "definite",
        "antonym_definition": "定義: 内容や予定が明確に決まっていて、曖昧さが少ない。"
      },
      {
        ...
        "sense_definition": "【日本語訳・定義】計画、日程、合意、結論、説明、提案、識別などが、現時点では候補として置かれているものの、検討・交渉・確認が終わっておらず、後で変更または撤回される可能性があることを表す。単に「一時的」という期間の短さではなく、内容の確定性がまだ低いことに焦点がある。",
        "antonym": "final",
        "antonym_definition": "定義: それ以上の変更・検討を予定しない最終的な。"
      }
    ]
  },
  "blind_protocol": {
