...
```json
{
    ...
    "antonym_items": [
      {
        ...
        "headword": "suspicion",
        "sense_definition": "【日本語訳・定義】人、組織、動機、考えなどをそのまま信用せず、「裏に何か問題・意図があるかもしれない」と疑って見る態度を表す。語義1のように特定の犯罪・不正行為を想定する必要はなく、広い意味での mistrust / distrust に近い。",
        "antonym": "trust",
        "antonym_definition": "定義: 人・組織・情報などを信頼し、頼ってよいと考えること。"
      }
    ]
  },
  "blind_protocol": {
  ...
  "normalized_input_sha256": "ccf084e1213173571f74ef1379047e709a7efff396c1370f09b661181921946e"
}
```
