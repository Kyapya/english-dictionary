...
Save exactly one JSON response as `evidence.response.raw.json`. The top-level JSON must include the routed `pass_id` and a `reviewer` object with `mode: "handoff"`, the actual `declared_model`, `ingested_by: "human"`, and a non-empty `agent_id`. Each checker pass must use a different agent_id.
## Prompt
...
```json
{
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "c4f86fc4261dc2f2a275018be6bbad0cb8e1036b315814170e8d74a208952f80",
    "source_first_artifact_sha256": "776daa0334bf140008a6fc56b0dd673a651dc4a3f85bfebd24a78f78fabd8085",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
    ...
    "sources": [
      ...
      {
        "id": "uk_house_of_lords_kebel",
        "locator": "https://publications.parliament.uk/pa/ld199899/ldjudgmt/jd991028/kabel-3.htm",
        "source_type": "official_primary",
        "independence_group": "uk_house_of_lords",
        "facts": [
          {
            "id": "ukhl_kebel_suspicion",
            "form": "suspicion / reasonable suspicion",
            "kind": "legal_definition",
            "statement": "In a criminal-law discussion of reasonable suspicion, the House of Lords judgment quotes Lord Devlin describing ordinary suspicion as conjecture or surmise where proof is lacking, arising near the start of an investigation before prima facie proof.",
            "source_detail": "Regina v Director of Public Prosecutions, ex parte Kebeline and Others, under “Striking the balance,” quoting Hussien v Chong Fook Kam; judgment lines 66–70 (especially the quoted ordinary meaning at line 67 and the distinction from prima facie proof at lines 68–70)."
          }
        ]
      }
    ],
    "source_union": [
      ...
      },
      {
        ...
        "source_fact_ids": [
          "mw_legal",
          "ukhl_kebel_suspicion"
        ],
        "canonical_statement": "Legal usage presents suspicion as a mental state short of belief and proof, based on no or slight evidence and earlier than prima facie proof.",
        "disposition": "integrated",
        "rationale": "The Merriam-Webster legal definition and a House of Lords judgment’s criminal-law discussion support the no-proof boundary and distinguish suspicion from prima facie proof."
      },
      {
        "id": "u_pronunciation",
        "source_fact_ids": [
    ...
    "claim_units": [
      ...
      },
      {
        ...
        "statement": "In legal usage, suspicion is a mental state short of belief based on no or slight evidence, and it precedes prima facie proof.",
        "article_target_ids": [
          "definition:001",
          "register:001"
        ],
        "source_supports": [
          ...
          {
            "source_fact_id": "ukhl_kebel_suspicion",
            "support_summary": "The House of Lords judgment quotes the legal description of ordinary suspicion as conjecture or surmise where proof is lacking and distinguishes it from prima facie proof."
          }
        ]
      },
      {
    ...
    "article_targets": [
      ...
      },
      {
        ...
        "text_sha256": "0db24f5582f53cae6bea7f8e1aa619aeb829b6a70ad21af6c3fd68641a37fa76",
        "requires_evidence": true,
        "evidence_policy": "two_sources_or_primary",
        "text": "十分な証拠はないが、犯罪・不正を含まない事実や状況が本当なのではないかと感じる推測・予感に焦点がある。本記事では、that節が特定の人の犯罪・不正行為を述べる用例は語義1に置き、語義3はそれ以外の事実・状況への推測に用いる。この用法では個々の考えを表す可算形が典型。可算・不可算は意味だけで一律に決まらず、構文にも左右される。"
      },
      {
        "id": "definition:004",
        "kind": "definition",
      ...
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "3. 【名詞・可算中心】～ではないかという気、確証のない推測",
        "text_sha256": "97c5c5522d54d5fc24f0c0554d60bf9d9355a2d85bb425c7b79f97c5e5f43aea",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "a suspicion that 〈non-wrongdoing clause〉＝〈犯罪・不正を含まない節〉ではないかという気"
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "3. 【名詞・可算中心】～ではないかという気、確証のない推測",
        "text_sha256": "cb8a10b500520f70684cb04f52a3921ecbadb1e2fca5e834250b48bcb0d18d93",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "have a suspicion that 〈non-wrongdoing clause〉＝〈犯罪・不正を含まない節〉ではないかと思う"
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "3. 【名詞・可算中心】～ではないかという気、確証のない推測",
        "text_sha256": "df742cfcbf59fe0843bd91875c491b31532ab48bb49a66c81b16bc74dcd3f558",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "a sneaking suspicion that 〈non-wrongdoing clause〉＝〈犯罪・不正を含まない節〉ではないかと思う気持ち"
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "3. 【名詞・可算中心】～ではないかという気、確証のない推測",
        "text_sha256": "4478937ed2f65916910df90e6d2921669b6bb25eb426ce534dfaeedea6153639",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "a strong suspicion that 〈non-wrongdoing clause〉＝〈犯罪・不正を含まない節〉という強い推測"
      },
      {
  ...
  "source_artifact_sha256": "776daa0334bf140008a6fc56b0dd673a651dc4a3f85bfebd24a78f78fabd8085",
  "normalization_version": "check_pass_semantic_input_v2",
  "normalized_input_sha256": "ee1d0a36ee7d0bb6aca2053d1cc0f030435ff3dbbed7865d01535656222b12d0"
}
```
