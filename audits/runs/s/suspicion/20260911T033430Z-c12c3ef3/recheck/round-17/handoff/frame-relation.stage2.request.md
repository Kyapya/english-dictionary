# Independent frame-relation stage 2 handoff

Stage: `checker_passes/frame-relation-antonym-axis-stage2`

This is the second stage for the same independent reviewer who completed stage 1. The response must be one `antonym_axis_adjudication_record_v1` JSON object saved as `frame-relation.stage2.response.raw.json`. Preserve the stage1 axes exactly, adjudicate every disclosed item once, and report frame findings and unrouted observations as required by the prompt.
...
```json
{
  ...
  "blind_request_sha256": "ba574d5657df440e0da448748e409acdc5566b8bd8c4131a9716ff35712aa1bb",
  "blind_record_sha256": "5eec8c1b7146d89148915945b24b7968471335201672bcd192d1780f477ae3e0",
  "input_sections": {
    "sense_structure": [
      {
        "line": 38,
