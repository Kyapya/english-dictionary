...
The same independent reviewer who completed stage 1 must perform this stage. Use the sealed stage-1 record and exact JSON request. Do not inspect other checker outputs or findings. Save one raw JSON response at `responses/frame-relation.stage2.response.raw.json`, with exact pass_id and reviewer object `{mode: handoff, declared_model: GPT-6, ingested_by: human, agent_id: r23-frame-relation-stage1-5178b4b7-b353-444b-98e2-d823f2c8f483}`. Include exact stage2_request_sha256 and blind_record_sha256. Preserve stage-1 raw response unchanged.
...
```json
{
  ...
  "blind_request_sha256": "889fe53611174ac33c59ab30f79ff209a33b064d0745236108911d5b2c99b142",
  "blind_record_sha256": "f136bda3fa061b58b4c3b600e052df3773731427a7d657e96251e249b29e6c15",
  "input_sections": {
    "sense_structure": [
      {
        "line": 38,
