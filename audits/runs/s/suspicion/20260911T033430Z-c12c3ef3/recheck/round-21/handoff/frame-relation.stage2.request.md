...
This is the serial second stage. Continue in the same reviewer context and use the same reviewer id/model as stage 1. Read only this packet, including its sealed stage-1 record hash. Do not inspect earlier rounds/findings or other passes. Save the raw adjudication record at `frame-relation.stage2.response.raw.json`.
...
```json
{
  ...
  "blind_request_sha256": "902516d0aabf3063a2feae716c82175c349b621b3026569e21e2ccc46a6135e9",
  "blind_record_sha256": "d62106619af5e15158189afac3eff1a3daa9d1d109fab8da35adcd7ad3d64591",
  "input_sections": {
    "sense_structure": [
      {
        "line": 38,
