...
Stage: `checker_passes/frame-relation/stage2`

Use the same independent reviewer identity as stage 1: `/root/r26_frame_relation`. Review the supplied exact stage-2 request, reconcile against the sealed blind record and alignment key already embedded, and do not rerun or alter stage 1. Save one raw JSON response at `responses/frame-relation.stage2.response.raw.json` with schema `antonym_axis_adjudication_record_v1`, the exact `stage2_request_sha256`, exact `blind_record_sha256`, pass_id `frame-relation`, and reviewer metadata `{mode: "handoff", declared_model: "GPT-6", ingested_by: "human", agent_id: "/root/r26_frame_relation"}.

Canonical `stage2_request_sha256`: `5817842f464b7e914a9d13c64b1cb126f59ed72295da71e4d4d8fe8972be49c7`. Canonical `blind_record_sha256`: `25762ac61b36855996be8fe028c76f49c4c00daa66e2e393d84266c0a19ce8b9`. Both are SHA-256 digests of the canonical JSON objects described in the packet.
...
```json
{
  ...
  "blind_request_sha256": "7108b85b66f7976a2212b168518c6fb7830fd5ba780981fe7d01a43832ac9861",
  "blind_record_sha256": "25762ac61b36855996be8fe028c76f49c4c00daa66e2e393d84266c0a19ce8b9",
  "input_sections": {
    "sense_structure": [
      {
        "line": 38,
