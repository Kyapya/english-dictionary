...
Stage: `checker_passes/evidence` round 26 (review)
...
```json
{
  ...
  "input_sections": {
    ...
    "collocations_examples": [
      ...
      {
        "line": 196,
        "text": "訳: その壁は白く、夕方の光の中ではほんのり青みを帯びていた。  "
      },
      {
        "line": 198,
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "25d65838057b83f82c023e80c753ad812781f807b27f35aa338a622e35efc766",
    "source_first_artifact_sha256": "71ecbb6ba67c4f2c9c14bc62d9ed607be1a54695728ccde7798ff3b3f68e0bc6",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
    ...
    "article_targets": [
      ...
      },
      {
        ...
        "text_sha256": "959a4395b5c7e9c4bc358156f0a60cee4510b499c6dbc188c3e19f5b9cd0e786",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "・a suspicion of 〈color〉\n用途: 色合いがごくわずかに混じって見えることを描写する。\n例: The walls were white with a suspicion of blue in the evening light.\n訳: その壁は白く、夕方の光の中ではほんのり青みを帯びていた。"
      },
      {
        "id": "collocation:014",
        "kind": "collocation",
  ...
  "normalized_input_sha256": "ca9a6f8c846c9e668efa9660f435c562cd573a6846724a5c5102af5836c392b9"
}
```
