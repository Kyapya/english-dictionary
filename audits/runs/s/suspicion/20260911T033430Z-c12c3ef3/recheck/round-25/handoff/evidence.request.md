...
Save the raw response at `responses/evidence.response.raw.json`. Include the exact `pass_id` and a top-level `reviewer` object with `mode: "handoff"`, your actual `declared_model`, `ingested_by: "human"`, and a unique non-empty `agent_id`. Use a different reviewer identity for each of the seven passes.
...
```json
{
  ...
  "input_body_sha256": "1668f193d23088ced53f1c8828fcef108cde97073b2eda3e14f74741e9d73a51",
  "input_sections": {
    "pronunciation": [
      {
        "line": 13,
    ...
    "frames": [
      ...
      {
        "line": 99,
        "text": "【文法パターン】regard/view 〈person/claim/proposal/action/decision〉 with suspicion＝〈人・主張・提案・行為・決定〉を疑いの目で見る／〈offer/proposal〉 be greeted with (some) suspicion＝〈申し出・提案〉が（多少の）疑いをもって受け止められる。  "
      },
      {
        "line": 131,
        "text": "3. 【名詞・可算中心】～ではないかという気、確証のない推測"
      ...
      {
        "line": 139,
        "text": "【文法パターン】a suspicion that 〈proposition/clause〉＝〈命題・節〉ではないかという気／have a suspicion that 〈proposition/clause〉＝〈命題・節〉ではないかと思う／a sneaking suspicion that 〈proposition/clause〉＝〈命題・節〉ではないかと思う気持ち／a strong suspicion that 〈proposition/clause〉＝〈命題・節〉という強い推測／confirm a suspicion＝推測を裏付ける。  "
      },
      {
        "line": 181,
        "text": "4. 【名詞・単数／formal（やや改まった）】ほんの少し、かすかな気配"
    ...
    "collocations_examples": [
      ...
      {
        "line": 51,
        "text": "用途: 人の行動などから、その人が犯罪・不正をしたのではないかという疑いが生じる。  "
      },
      {
        "line": 52,
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "f0d8d3297fddf09d41735415f8d9c67191f32e2fb049614c1391e93f31dafde4",
    "source_first_artifact_sha256": "4d88fc32b04e814ebbb1861a6f3a52c3b9b796109da4cb9434ef19a6bef68155",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
    ...
    "sources": [
      ...
      },
      {
        ...
        "facts": [
          ...
          {
            "id": "oxf_arouse",
            "form": "arouse suspicion",
            "kind": "collocation",
            "statement": "Oxford gives arouse suspicion in its sense 1 examples: people avoid arousing suspicion, and parked vehicles that arouse suspicion should be reported to police.",
            "source_detail": "Oxford entry, noun sense 1 examples and Extra Examples; the examples connect arousing suspicion with possible wrongdoing and police reporting."
          }
        ]
      },
      {
        "id": "oxford_pronunciation_documentation",
        "locator": "https://www.oxfordlearnersdictionaries.com/external/pdf/english/OALD10_phons_GL.pdf",
        "source_type": "pronunciation_documentation",
        "independence_group": "oxford_university_press",
        "facts": [
          {
            "id": "oxf_syllabic_n",
            "form": "syllabic /n/",
            "kind": "pronunciation_convention",
            "statement": "OALD10 does not mark syllabic consonants [n̩] and [l̩] with a diacritic where syllabicity is implied by position, illustrating the convention with station and little.",
            "source_detail": "Gary Leicester, Phonetics Editor for OALD10, “Pronunciation in the 10th edition of the Oxford Advanced Learner’s Dictionary,” Oxford University Press, pp. 3–4 (PDF pp. 3–4): the OALD omits the syllabic-consonant diacritic for [n̩] and [l̩] in part because position implies it."
          }
        ]
      }
    ],
    "source_union": [
      {
        ...
        "rationale": "Oxford gives the on suspicion of pattern and an arrest example; a separate police release is not needed to support the usage."
      },
      {
        "id": "u_distrust",
        "source_fact_ids": [
      ...
      },
      {
        ...
        "canonical_statement": "Merriam-Webster describes legal suspicion as a mental state usually short of belief, based on no proof or slight evidence.",
        "disposition": "integrated",
        "rationale": "The mapped article target attributes that no-proof/slight-evidence, short-of-belief definition to Merriam-Webster; it does not state the prima facie-proof relation from the separate judgment."
      },
      {
        "id": "u_pronunciation",
        "source_fact_ids": [
        ...
        "canonical_statement": "Oxford gives the UK/US transcription and its convention for unmarked syllabic /n/; Merriam-Webster marks primary stress on the second syllable.",
        "disposition": "integrated",
        "rationale": "The article explains Oxford’s final syllabic /n/ notation and compares its three syllables with Merriam-Webster’s respelling."
      },
      {
        "id": "u_that_belief",
        "source_fact_ids": [
      ...
      },
      {
        ...
        "canonical_statement": "Merriam-Webster records suspicion as a transitive verb labelled chiefly dialectal; American Heritage records an informal verb sense, both with suspicioned and suspicioning forms.",
        "disposition": "integrated",
        "rationale": "The article reports these two dictionary register labels and limits its entry to the noun; the sources do not establish a contemporary frequency claim."
      },
      {
        "id": "u_word_family",
        "source_fact_ids": [
    ...
    "claim_units": [
      {
        ...
        "source_supports": [
          ...
          {
            "source_fact_id": "oxf_arouse",
            "support_summary": "Oxford places arouse suspicion examples under the sense for suspecting someone has done something wrong, including a police-reporting example."
          }
        ]
      },
      {
        ...
        "source_supports": [
          {
            ...
            "support_summary": "Oxford gives on suspicion of plus a crime as an arrest pattern and illustrates it with an arrest example."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "statement": "Oxford gives the same British and American IPA form and describes its convention for syllabic /n/; Merriam-Webster marks primary stress on the second syllable.",
        "article_target_ids": [
          "pronunciation:001"
        ],
        "source_supports": [
          ...
          {
            "source_fact_id": "oxf_syllabic_n",
            "support_summary": "OALD10 explains that its transcriptions omit a syllabic-consonant mark when position makes syllabicity clear."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "statement": "Merriam-Webster describes legal suspicion as a mental state usually short of belief, based on no proof or slight evidence.",
        "article_target_ids": [
          "definition:001",
          "register:001"
        ],
        "source_supports": [
          {
            ...
            "support_summary": "Merriam-Webster defines legal suspicion as a mental state usually short of belief, based on no proof or slight evidence."
          }
        ]
      },
      {
      ...
      {
        "id": "claim_verb_register",
        "union_ids": [
          "u_verb_register"
        ],
        "subject_form": "suspicion",
        "claim_type": "dictionary_register",
        "statement": "Merriam-Webster labels the verb suspicion chiefly dialectal; American Heritage labels it informal.",
        "article_target_ids": [
          "word_formation:002"
        ],
        "source_supports": [
          {
            ...
            "support_summary": "Merriam-Webster records the transitive verb and labels it chiefly dialectal."
          },
          {
            "source_fact_id": "ahd_verb",
            "support_summary": "American Heritage records the informal verb sense and its forms."
          }
        ]
      }
    ],
    "article_targets": [
      {
        ...
        "text_sha256": "dc7079b86517cebd16d870cacb85e90fcf406004fc00ed75b0e20030f7c44229",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "・arouse suspicion\n用途: 人の行動などから、その人が犯罪・不正をしたのではないかという疑いが生じる。\n例: Among the auditors, the unexplained transfer of client funds aroused suspicion that the treasurer had committed fraud.\n訳: 監査担当者の間では、顧客資金の使途不明な移動により、会計係が詐欺を行ったのではないかという疑いが生じた。"
      },
      {
        "id": "collocation:002",
        "kind": "collocation",
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "1. 【名詞・可算／不可算】容疑、犯罪・不正をしたのではないかという疑い",
        "text_sha256": "a965e38b1700774e312566d57c2318bcfdd3aa0ecb9f0b22fc7807dd33493f42",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "・on suspicion of 〈crime〉\n用途: 警察などが、ある犯罪を行った疑いを理由に人を逮捕したことを述べる。\n例: Two people were arrested on suspicion of fraud after the investigation.\n訳: 捜査後、2人が詐欺の容疑で逮捕された。"
      },
      {
        "id": "collocation:003",
        "kind": "collocation",
      ...
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "1. 【名詞・可算／不可算】容疑、犯罪・不正をしたのではないかという疑い",
        "text_sha256": "568f6b100e67ddd338b7cf518d6bdbc558f6493db168ab41c22e49a8b2fbc5cf",
        "requires_evidence": true,
        "evidence_policy": "two_sources_or_primary",
        "text": "人が犯罪、不正、不誠実な行為をしたとして疑いの対象になること、またはその人の行為に不正の容疑を向けることを表す。焦点は、ある命題の真偽を予想すること自体より、特定の人がその行為をしたとして疑われている点にある。that節を伴う例もあるが、節の話題だけで語義を決めず、人への容疑を表す場合は語義1に置く。複数の個別の疑いを述べる suspicions は可算、疑いという状態を表す suspicion は不可算で使われる。on suspicion of ... のように特定の容疑でも無冠詞となる定型表現があるため、可算・不可算は意味だけで一律には決まらない。"
      },
      {
        "id": "definition:002",
        "kind": "definition",
      ...
      },
      {
        ...
        "text_sha256": "0d0da78ce342e239a78f0f71f71ac93c1704dca56ba9f6e875fd20352a2e749b",
        "requires_evidence": true,
        "evidence_policy": "two_sources_or_primary",
        "text": "十分な証拠がなくても、ある命題や状況が真かもしれないと考える、話者の暫定的な推測・予感を表す。焦点は命題の真偽にあり、特定の人を犯罪・不正の容疑者として扱うこと自体ではない。that節の話題だけで語義を決めず、節全体についての推測は語義3、特定の人へ行為の容疑を向ける用法は語義1に置く。この用法では個々の考えを表す可算形が典型。可算・不可算は意味だけで一律に決まらず、構文にも左右される。"
      },
      {
        "id": "definition:004",
        "kind": "definition",
      ...
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "1. 【名詞・可算／不可算】容疑、犯罪・不正をしたのではないかという疑い",
        "text_sha256": "0bedc5afd8262d2cd0248476d05be9c7c008d56cd64c3b66cac6cfcaef0ab8e6",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "suspicion that 〈person committed a crime/wrongdoing〉＝〈人が犯罪・不正をした〉のではないかという疑い"
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "1. 【名詞・可算／不可算】容疑、犯罪・不正をしたのではないかという疑い",
        "text_sha256": "f8b7f7c050a79a960dce818cf87d28cc9a280433b2dc5bc63c0b9be0ddb08628",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "arouse suspicion that 〈person committed a crime/wrongdoing〉＝〈人が犯罪・不正をした〉という疑いを招く"
      },
      {
      ...
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "2. 【名詞・不可算中心】不信、警戒を伴う疑念",
        "text_sha256": "b69f12e315dcdaa5c1d57257bb455ae287da97254e37a901af1dd1a08a0022a4",
        "requires_evidence": true,
        "evidence_policy": "one_source",
      ...
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "3. 【名詞・可算中心】～ではないかという気、確証のない推測",
        "text_sha256": "de1f874de042d50408e29ecc8e24696f4ef2736366bae25813ea38b43d9da899",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "a suspicion that 〈proposition/clause〉＝〈命題・節〉ではないかという気"
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "3. 【名詞・可算中心】～ではないかという気、確証のない推測",
        "text_sha256": "24f216ce11626908e0f964e7530a1197bc91ea4282b64f8a55872820b7dcfd46",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "have a suspicion that 〈proposition/clause〉＝〈命題・節〉ではないかと思う"
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "3. 【名詞・可算中心】～ではないかという気、確証のない推測",
        "text_sha256": "3f6c87b5dd6045d2b0508639762aa7214b460cc26de9a01a6932fc07738a80dc",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "a sneaking suspicion that 〈proposition/clause〉＝〈命題・節〉ではないかと思う気持ち"
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "3. 【名詞・可算中心】～ではないかという気、確証のない推測",
        "text_sha256": "932191d4ae2c4d7a2cb57517f9e8f7528973366a856ad4a20a07e1a96f18fafb",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "a strong suspicion that 〈proposition/clause〉＝〈命題・節〉という強い推測"
      },
      {
      ...
      },
      {
        ...
        "section": "＃発音記号",
        "sense": "",
        "text_sha256": "094bcbaf0a01acbf0d0efc277cba524a4d6dcd142b10de3cf229c6300f2328d8",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "Oxford は米・英とも /səˈspɪʃn/ と表記する。Oxford Advanced Learner’s Dictionary（OALD10）の解説では、位置から分かる音節主音 /n/ は [n̩] のような補助記号を付けずに表す。このため /səˈspɪʃn/ の語末 /n/ が音節を担い、全体は3音節と読める。Merriam-Webster の音節別表記 sə-ˈspi-shən も3音節で、第2音節に主強勢を置く。語頭の su- は強く /suː/ と読まず、弱い /sə/ になる。"
      },
  ...
  "source_artifact_sha256": "4d88fc32b04e814ebbb1861a6f3a52c3b9b796109da4cb9434ef19a6bef68155",
  "normalization_version": "check_pass_semantic_input_v2",
  "normalized_input_sha256": "2eeb43e1f024216d98896ae8175c5fca3073c4a23fb8d11d725569fc3a88099c"
}
```
