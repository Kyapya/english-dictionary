...
Use the same independent reviewer identity as stage 1: `/root/r25_frame_relation`. Review the supplied exact stage-2 request, reconcile against the sealed blind record and alignment key already embedded, and do not rerun or alter stage 1. Save one raw JSON response at `responses/frame-relation.stage2.response.raw.json` with schema `antonym_axis_adjudication_record_v1`, the exact `stage2_request_sha256`, exact `blind_record_sha256`, pass_id `frame-relation`, and reviewer metadata `{mode: "handoff", declared_model: "GPT-6", ingested_by: "human", agent_id: "/root/r25_frame_relation"}.
...
```json
{
  ...
  "blind_request_sha256": "2f534222f4f8f2ecb687935302cf6962f5fad9acf355f85d91a592fc44e5f9cf",
  "blind_record_sha256": "4db5aa9e2c0f1a3c21736cdcaa3fd37b14ea69a2b1f68b82425b1fc14d9a59a1",
  "input_sections": {
    "sense_structure": [
      {
        "line": 38,
