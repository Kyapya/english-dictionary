...
Save the raw response at `responses/qualification.response.raw.json`. Include the exact `pass_id` and a top-level `reviewer` object with `mode: "handoff"`, your actual `declared_model`, `ingested_by: "human"`, and a unique non-empty `agent_id`. Use a different reviewer identity for each of the seven passes.
...
```json
{
  ...
  "normalized_input_sha256": "53d63aa6cf4d020c6365e74bb22ebd6b7f4cc39f4202e0c01bb901bc71926fc0"
}
```
