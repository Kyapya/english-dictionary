...
Return one `antonym_axis_adjudication_record_v1` JSON object matching the supplied packet. Use your same actual agent ID and declared model from stage 1; do not consult another checker pass, prior reviews, resolutions, or blind findings. Save the exact raw response in `frame-relation.stage2.response.raw.json`.
...
```json
{
  ...
  "blind_request_sha256": "29ee7d1657986046e7e96fbd327d69b21b6e4f9525fadda707e350114351f1ea",
  "blind_record_sha256": "ce59c0505074c79b17263b5584fe1a42385e94251d7437a0ea22da70257c2aac",
  "input_sections": {
    "sense_structure": [
      {
        "line": 38,
