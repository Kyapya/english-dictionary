...
This stage must be performed by the same reviewer as stage 1: `/root/frame13_retry`, declared model `GPT-6`. Do not rerun any other checker pass.
...
```json
{
  ...
  "blind_record_sha256": "6e5c7b9d08ffbfed8549baa50e9775776bd4a306fb9db2683e01ae7467c591c1",
  "input_sections": {
    "sense_structure": [
      {
        "line": 36,
