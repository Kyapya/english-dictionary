...
Save exactly one JSON response as `evidence.response.json`. The top-level JSON must include the routed `pass_id` and a `reviewer` object with `mode: "handoff"`, the actual `declared_model`, `ingested_by: "human"`, and a non-empty `agent_id`. Each checker pass must use a different agent_id.
## Prompt
...
```json
{
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "966b58df5f529f684087ad1ca670914a827f682c035084c0077c1368a8d3d915",
    "source_first_artifact_sha256": "d44f6f1eb825f6bfcff285716c87db277e5c8ceaeff55140e230ec57726868a2",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
  ...
  "normalized_input_sha256": "93043fd4a2ea7ff22235fa2c03b25b1b1f728e51d4bc95f179338d7fd1e9952d"
}
```
