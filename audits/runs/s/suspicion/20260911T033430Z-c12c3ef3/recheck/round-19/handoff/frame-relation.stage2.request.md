...
Stage: `checker_passes/frame-relation` stage 2

Continue with the same independent reviewer context that completed stage 1. Use the exact saved stage-2 packet, preserve stage-1 judgments, and return only the required JSON response with the actual reviewer metadata.
...
```json
{
  ...
  "blind_request_sha256": "94ff6a6951b6f140959f3df9857add088d6937b69c306b84de3ab697838a256d",
  "blind_record_sha256": "3da2f42c47a9988595010f9984576be98cfeaed84dfd4f94ddf265ca064b741c",
  "input_sections": {
    "sense_structure": [
      {
        "line": 38,
