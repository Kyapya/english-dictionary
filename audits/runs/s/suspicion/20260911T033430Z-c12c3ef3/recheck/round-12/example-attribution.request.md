...
Stage: `checker_recheck/round-12/example-attribution`

Run this request in an independent reviewer context. Do not read another pass request or response. Save one raw JSON response to `example-attribution.blind-record.response.json`. Include pass_id and reviewer metadata with `mode: "handoff"`, your actual `declared_model`, `ingested_by: "human"`, and `agent_id: "/root/r12_example_attribution".
...
```json
{
  ...
  "input_sections": {
    ...
    "collocations_examples": [
      {
        "example_id": "ex-fcfc5fd6ac5e",
        "example": "Residents regarded the sudden policy change with suspicion.",
        "translation": "住民たちは突然の方針変更を疑いの目で見た。"
      },
      {
        "example_id": "ex-e3b6d6c9114e",
        "example": "The unexplained delay raised some suspicion.",
        "translation": "説明のつかない遅れが、多少の疑いを招いた。"
      },
      {
        "example_id": "ex-cd44bb14b62b",
