...
Stage: `checker_recheck/round-12/evidence`

Run this request in an independent reviewer context. Do not read another pass request or response. Save one raw JSON response to `evidence.response.json`. Include pass_id and reviewer metadata with `mode: "handoff"`, your actual `declared_model`, `ingested_by: "human"`, and `agent_id: "/root/r12_evidence".
...
```json
{
  ...
  "input_sections": {
    ...
    "frames": [
      ...
      {
        "line": 44,
        "text": "【文法パターン】suspicion that 〈clause〉＝～ではないかという疑い／have a suspicion that 〈clause〉＝～ではないかという疑いを抱く／arouse 〈person〉's suspicions that 〈clause〉＝〈人〉に～ではないかという疑いを起こさせる／raise some suspicion＝疑いを招く／on suspicion of 〈offence〉＝〈犯罪〉の容疑で／be under suspicion＝疑いをかけられている。  "
      },
      {
        "line": 89,
        "text": "2. 【名詞・可算／不可算】不信、警戒を伴う疑念"
    ...
    "collocations_examples": [
      ...
      {
        "line": 74,
        "text": "用途: ある発言や出来事が疑いを招くことを表す。  "
      },
      {
        "line": 75,
        "text": "例: The unexplained delay raised some suspicion.  "
      },
      {
        "line": 76,
        "text": "訳: 説明のつかない遅れが、多少の疑いを招いた。  "
      },
      {
        "line": 89,
        "text": "2. 【名詞・可算／不可算】不信、警戒を伴う疑念"
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "048e107a5d126a0f638b658afb72ddee168cd9894325be20ff63c11db1668321",
    "source_first_artifact_sha256": "cff7da1f22ae25fe071b48da51af07d50df1d6d825a6330a6abac5cdfc52420c",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
      ...
      },
      {
        ...
        "facts": [
          ...
          },
          {
            ...
            "form": "suspicion",
            "kind": "sense",
            "statement": "A feeling that a person or thing cannot be trusted; countable and uncountable use.",
            "source_detail": "Oxford Advanced American Dictionary, sense 3: “the feeling that you cannot trust someone or something”; the entry marks uncountable/countable use, retrieved line 109."
          },
          {
            "id": "F-OUP-4",
            "form": "suspicion",
    ...
    "claim_units": [
      {
        ...
        "source_supports": [
          ...
          },
          {
            ...
            "support_summary": "Oxford defines suspicion here as the feeling that a person or thing cannot be trusted."
          },
          {
      ...
      },
      {
        ...
        "subject_form": "suspicion",
        "claim_type": "sense",
        "statement": "The Oxford Advanced American Dictionary’s third sense of suspicion describes a feeling that a person or thing cannot be trusted.",
        "article_target_ids": [
          "definition:002",
          "synonym:002"
        ],
      ...
      },
      {
        ...
        "subject_form": "suspicion",
        "claim_type": "frame",
        "statement": "Merriam-Webster examples attest suspicion that + clause, arouse someone's suspicions that + clause, raise some suspicion, and regard a plan with suspicion as separate patterns; its raise example is the bare phrase.",
        "article_target_ids": [
          "grammar_pattern:001",
          "grammar_pattern:002",
          "grammar_pattern:003",
        ...
        "source_supports": [
          {
            ...
            "support_summary": "Merriam-Webster gives separate suspicion-that, arouse-someone's-suspicions-that, raise-some-suspicion, and with-suspicion examples; the raise example is bare and does not attest an added among + that clause."
          }
        ]
      },
      {
    ...
    "article_targets": [
      ...
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "1. 【名詞・可算／不可算】疑い、推測：ある事柄が真実かもしれないと考えること。特に犯罪・不正への疑い",
        "text_sha256": "3ca899e4483413be1371dbd7a8ba62a71454c02b86c9731aa2423cbd200467b6",
        "requires_evidence": true,
        "evidence_policy": "one_source",
      ...
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "1. 【名詞・可算／不可算】疑い、推測：ある事柄が真実かもしれないと考えること。特に犯罪・不正への疑い",
        "text_sha256": "f59fbebe6c1c06a5956fb0b947b741ccb42dacc5a6d25c5520423db2ce2c4cc3",
        "requires_evidence": true,
        "evidence_policy": "one_source",
      ...
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "2. 【名詞・可算／不可算】不信、警戒を伴う疑念",
        "text_sha256": "d93334b8ae75df015a802ecd689a3adece48a05f5d6f7743fee02f63b68b707c",
        "requires_evidence": true,
        "evidence_policy": "two_sources_or_primary",
      ...
      },
      {
        ...
        "section": "＃語形成",
        "sense": "",
        "text_sha256": "78ecb479fc50d6f2292d38ce3085baaaf38289ddb7e88eb82f589f4bcb55a458",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "・suspicion（動詞）は他動詞で「～を疑う」。Merriam-Webster では chiefly dialectal とされるため、以下の主要な学習語義には採録しない。"
      }
