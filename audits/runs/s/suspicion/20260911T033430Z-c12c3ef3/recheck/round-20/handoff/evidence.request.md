...
Run this request in its own independent agent/session. Do not read earlier round findings or discuss other checker passes. Save one top-level response as `evidence.response.raw.json` with the exact pass_id, a reviewer object (`mode`: `handoff`, actual `declared_model`, `ingested_by`: `human`, and a unique non-empty `agent_id`), and the required response fields.
...
```json
{
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "832e1db3b8eb79df2b6cc7950a77826f7277ddfc2251013dcfbabac10d8731d0",
    "source_first_artifact_sha256": "c4d6a722a2ef61df4e79540139861bf23bca9ff974f924f688831d5ad846161a",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
  ...
  "normalized_input_sha256": "e297095b02e0be66ebca6585a7d8dea3b2db6f1de11635a8fe3e3b1558dd1cb7"
}
```
