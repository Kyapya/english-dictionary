...
Use the same independent reviewer identity as stage 1: `codex-frame-relation-round24-reviewer-20260924`. Review the supplied exact stage-2 request, reconcile against the sealed blind record and alignment key already embedded, and do not rerun or alter stage 1. Save one raw JSON response at `responses/frame-relation.stage2.response.raw.json` with schema `antonym_axis_adjudication_record_v1`, the exact `stage2_request_sha256`, exact `blind_record_sha256`, pass_id `frame-relation`, and reviewer metadata `{mode: "handoff", declared_model: "GPT-6", ingested_by: "human", agent_id: "codex-frame-relation-round24-reviewer-20260924"}.
...
```json
{
  ...
  "blind_request_sha256": "4f0e27776312b14b3bff82d9b2c82ba01efab149cfb7c7191d8fbf8b409d391d",
  "blind_record_sha256": "877792c8eebcbd0aa713ffc1ab407ac5381b4ca7b21fbf763a39d42d220e4b8f",
  "input_sections": {
    "sense_structure": [
      {
        "line": 38,
