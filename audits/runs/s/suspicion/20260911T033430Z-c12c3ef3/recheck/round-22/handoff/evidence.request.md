...
Run this request in its own fresh independent agent/session. Do not read earlier round findings or discuss other checker passes. Save one top-level response as `evidence.response.raw.json` with the exact pass_id, reviewer metadata (`mode`: `handoff`, actual `declared_model`, `ingested_by`: `human`, unique non-empty `agent_id`), and required fields.
...
```json
{
  ...
  "input_body_sha256": "08c32581fbc222d720287159ce03804197e14b84a5afa55587c5dc1ac53ad6d6",
  "input_sections": {
    "pronunciation": [
      {
        "line": 13,
  ...
  "evidence_context": {
    ...
    "source_inventory_sha256": "f940ad43ee56bef4170b981a490e1605335fbc5ad41a25ea56d8cde4d4fdb72b",
    "source_first_artifact_sha256": "287477944bad8b878899556bfcf83a76bef96866be7c9cd6a47cdbbef8072f76",
    "relevant_sections": [
      "collocations_examples",
      "core_image",
      "etymology",
    ...
    "article_targets": [
      ...
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "2. 【名詞・不可算中心】不信、警戒を伴う疑念",
        "text_sha256": "88da16350b701509283e5f69c984e19df786845e29eb51e80b61aaa214bae9b3",
        "requires_evidence": true,
        "evidence_policy": "one_source",
      ...
      },
      {
        ...
        "section": "＃意味・用法・関連表現",
        "sense": "2. 【名詞・不可算中心】不信、警戒を伴う疑念",
        "text_sha256": "b49602d777880104669cf00c34482772e207d92028431a7976108c57f3dd875a",
        "requires_evidence": true,
        "evidence_policy": "one_source",
        "text": "cast suspicion on 〈claim/statement or its truth/reliability〉＝〈主張・説明、またはその真実性・信頼性〉に疑いを向ける。"
      },
      {
  ...
  "source_artifact_sha256": "287477944bad8b878899556bfcf83a76bef96866be7c9cd6a47cdbbef8072f76",
  "normalization_version": "check_pass_semantic_input_v2",
  "normalized_input_sha256": "190db78d1c15a7db40f30d6a0a995d6229a64a113995b6fe5e56db59162eea0a"
}
```
