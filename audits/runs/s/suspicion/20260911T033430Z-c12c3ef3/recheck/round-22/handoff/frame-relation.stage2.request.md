...
The stage-1 blind record is saved and provenance-bound. Continue in the same reviewer id, model, and context. Read only this packet and the supplied checker prompt. The alignment key is now disclosed; do not revise the sealed blind record. Compare each saved axis with the actual antonym-side sense and apply the prompt’s stage-2 rules. Save a separate response at `frame-relation.stage2.response.raw.json` with schema_version `antonym_axis_adjudication_record_v1`, pass_id, input_body_sha256, stage2_request_sha256, blind_record_sha256, reviewer metadata (same id/model as stage 1, ingested_by human), adjudications, frame_findings, and unrouted_observations.
...
```json
{
  ...
  "blind_request_sha256": "6838b376936c1884b36a365b923c0564a6ba2682cb1383797b5fb3c43e554721",
  "blind_record_sha256": "6cc223edbf0a56d9d97ba19109f456b4b929298de69e44b49c479f3268083470",
  "input_sections": {
    "sense_structure": [
      {
        "line": 38,
