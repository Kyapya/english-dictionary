    ...
    "antonym_items": [
      {
        ...
        "headword": "scope",
        "sense_definition": "【日本語訳・定義】人が何かをしたり、能力を伸ばしたりするために残されている余地・機会。scope for + 名詞・動名詞 が最も定着しており、十分な余地にも、ほとんど余地がない状態にも使える。実際に成功する機会を保証する語ではなく、可能性を活かせる空間を表す。",
        "antonym": "constraint",
        "antonym_definition": "定義: 行動、選択、発展を制限する条件・制約。"
      },
      {
        ...
        "sense_definition": "【日本語訳・定義】人が何かをしたり、能力を伸ばしたりするために残されている余地・機会。scope for + 名詞・動名詞 が最も定着しており、十分な余地にも、ほとんど余地がない状態にも使える。実際に成功する機会を保証する語ではなく、可能性を活かせる空間を表す。",
        "antonym": "restriction",
        "antonym_definition": "定義: 行動や利用を制限する規則・制限。"
      }
    ]
  },
  "blind_protocol": {
