...
```json
{
  ...
  "input_sections": {
    ...
    "frames": [
      ...
      {
        "line": 61,
        "text": "【文法パターン】scope for 〈名詞・動名詞〉＝～の余地・機会／scope for somebody to do＝人が～する余地／give/allow somebody scope to do＝人に～する余地を与える／have plenty/little scope for＝～の余地が十分にある・ほとんどない／within somebody's scope＝人の裁量・能力の範囲内で  "
      },
      {
        "line": 133,
        "text": "2. 【名詞・不可算】主題・活動・調査などが扱う範囲、対象領域"
      ...
      {
        "line": 141,
        "text": "【文法パターン】the scope of 〈本・調査・計画・活動〉＝～が扱う範囲／within/beyond/outside the scope of＝～の範囲内・範囲外／broaden/expand/widen the scope of＝～の範囲を広げる／narrow/limit/reduce the scope of＝～の範囲を狭める／broad/narrow in scope＝範囲が広い・狭い  "
      },
      {
        "line": 209,
        "text": "3. 【名詞・不可算】人・組織の能力、知識、権限が及ぶ範囲"
      ...
      {
        "line": 217,
        "text": "【文法パターン】within/outside/beyond one's scope＝自分の能力・担当範囲内／範囲外／the scope of 〈役割・権限〉＝役割・権限の及ぶ範囲／fall within somebody's scope＝人の担当範囲に入る／extend the scope of 〈権限・サービス〉＝権限・サービスの範囲を広げる  "
      },
      {
        "line": 273,
        "text": "4. 【名詞・可算】望遠鏡・内視鏡・照準器などのスコープ、観察器具"
      ...
      {
        "line": 281,
        "text": "【文法パターン】look/view through a scope＝スコープを通して見る／look into a scope＝スコープをのぞく／a scope on 〈銃・器具〉＝銃などに取り付けたスコープ／mount/adjust a scope＝スコープを取り付ける・調整する／under the scope＝スコープによる観察下で  "
      },
      {
        "line": 337,
        "text": "5. 【名詞・論理学・言語学】量化子・否定・修飾語などの作用域"
      ...
      {
        "line": 345,
        "text": "【文法パターン】the scope of 〈a quantifier・negation〉＝量化子・否定の作用域／take scope over 〈表現〉＝～に作用域を及ぼす／wide/narrow scope＝広い・狭い作用域／scope ambiguity＝作用域の曖昧性／within the scope of 〈operator〉＝演算子の作用域内で  "
      },
      {
        "line": 401,
        "text": "6. 【名詞・コンピューター】プログラム内で名前や値を参照できる範囲、実行コンテキスト"
      ...
      {
        "line": 409,
        "text": "【文法パターン】the scope of 〈a variable・a function〉＝変数・関数のスコープ／global/local/function/block scope＝グローバル・ローカル・関数・ブロックスコープ／be in scope＝参照可能な範囲にある／be out of scope＝現在の範囲から参照できない／within the scope of 〈a function・a block〉＝関数・ブロックのスコープ内で  "
      },
      {
        "line": 465,
        "text": "7. 【他動詞・くだけた用法】場所・人・状況などを詳しく調べる、下見する"
      ...
      {
        "line": 473,
        "text": "【文法パターン】scope 〈場所・人・状況〉＝～を詳しく調べる／scope 〈場所・人・状況〉 out＝～を下見する・調べる／scope out 〈場所・人・状況〉＝～を下見する／scope it/them out＝それを・彼らを下見する／be scoping out 〈対象〉＝～を調査中である  "
      },
      {
        "line": 534,
        "text": "8. 【他動詞・主にビジネス／技術】仕事・計画・解決策の範囲や必要条件を見積もり、定める"
      ...
      {
        "line": 542,
        "text": "【文法パターン】scope 〈project・work・solution〉＝プロジェクトなどの範囲を定める／scope 〈work〉 for 〈目的・条件〉＝目的などに合わせて作業範囲を定める／scope out 〈requirements・costs〉＝要件・費用を下調べする／be fully scoped＝範囲・要件が十分に定義されている／scope 〈a solution〉 to do＝～する解決策の範囲を定める  "
      },
      {
        "line": 598,
        "text": "9. 【他動詞・技術】望遠鏡・内視鏡などで見る、観察する"
      ...
      {
        "line": 606,
        "text": "【文法パターン】scope 〈空・天体〉＝望遠鏡で～を見る／scope 〈身体部位・関節〉＝内視鏡などで～を検査する／be scoped＝スコープで検査される／scope 〈対象〉 with 〈instrument〉＝器具で対象を見る  "
      },
      {
        "line": 657,
        "text": "10. 【他動詞・技術】銃などにスコープを取り付ける、スコープ付きにする"
      ...
      {
        "line": 665,
        "text": "【文法パターン】scope 〈a rifle・a firearm〉＝ライフルなどにスコープを取り付ける／a scoped 〈rifle・weapon〉＝スコープ付きのライフルなど／be scoped＝スコープを装備している  "
      }
    ],
    "collocations_examples": [
      {
    ...
    "antonym_axis_items": [
      {
        ...
        "anchor": {
          ...
          "line_start": 119,
          "line_end": 119,
          "exact_quote": "・constraint  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 122,
          "line_end": 122,
          "exact_quote": "違い: constraint は自由に使える余地を狭める制約そのものを表し、scope はその制約の中で残る可能性・裁量を表す。程度上の対立である。  "
        }
      },
      {
        ...
        "anchor": {
          ...
          "line_start": 126,
          "line_end": 126,
          "exact_quote": "・restriction  "
        },
        "difference_anchor": {
          "section": "lexical_relations",
          "line_start": 129,
          "line_end": 129,
          "exact_quote": "違い: restriction は外から課される禁止・制限に焦点がある。scope は制限そのものだけでなく、許される側の余地にも使う。  "
        }
      }
    ],
    "antonym_axis_senses": [
      {
        ...
        "full_sense": [
          ...
          {
            "line": 92,
            "text": "room は会話でより直接的に「余地」を表し、scope は計画・仕事・能力を評価する分析的な響きがある。opportunity は実際に利用できる機会を指しやすいのに対し、scope は機会が残されている可能性・裁量に焦点を置く。  "
          },
          {
            "line": 94,
            "text": "【類義語】"
